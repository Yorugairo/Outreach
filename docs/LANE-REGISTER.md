...
| --- | --- | --- | --- | --- | --- | --- |
| P61 parent (Claude/Fable) + its Opus lanes | main checkout, this register's author | P61 T13 (the dark span default) next, then T3b, T3c, T6b, T11 - T7b landed 2026-09-16 (HG7b on the queue) | the queue (`review-queue.v1.json` + `REVIEW-QUEUE.md`), the P61 plan, `CAPABILITIES.md` rows 37 / 119 (written, uncommitted - ride with the audio lane's row), `BACKLOG.md` rows R26-137..151 | free until T13 is dispatched | E99 s49-s53 (committed); next free after the audio lane's s54: **s55** | none in progress |
