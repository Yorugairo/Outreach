...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `C:/Users/Snipe/Downloads/Outreach Program` | `main` | P62 parent (Claude/Fable) + its Opus lanes - this register's author | doctrine, gates, evidence, review; P61 / P63 / P64 complete | P62 T2 (this register, the checklist, the record) | the queue (`review-queue.v1.json` + `REVIEW-QUEUE.md`), the plans, `CAPABILITIES.md` / `BACKLOG.md` rows it owns | FREE - no holder since P61 T14 (2026-09-16) | E99 s49-s53, s55-s65 (committed); next free: **s66** | is main |
