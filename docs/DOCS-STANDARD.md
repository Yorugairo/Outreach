...
- `content/video_engine/sources/reference_analyses/give-me-10-minutes-make-videos-addicting/REPORT.md:22` Quantitative Camera Telemetry
...
- `docs/research/motion/LIVING_METALLIC_DROP_RESEARCH_BLUEPRINT.md:1` Research Blueprint — The Living Metallic Drop: Surface Modes, Damping, the Highlight, and the Stop-Motion Craft of a Heavy Ball
...
Headings that name a filing slot, not a concept (22).
...
- `content/video_engine/projects/systems-and-blowups/ai-slower-useful-faster/PRODUCTION-LEDGER.md:20` Next steps
