...
| **Feathered spotlight** | yt-feather-highlight | dim the frame except a feathered ellipse that GLIDES between declared targets (a document region → a datum) | CSS-variable hole position/size, helpers tween it | annotation/highlight only; 0 motion-density events per glide (E99 s91) |
