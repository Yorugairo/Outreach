# The ART-embed plate - the order for human gate 3 (P50 T7, 2026-09-11)
...
the information layer is composited afterward). The rest of the plate is the house world.

**The order (Money Physics, the house woodblock world; portrait 9:16 first, a landscape sibling if cheap):**

> A quiet study at night in the Money Physics woodblock style - ink on cream, the deckle edge, chalk-light on
> charcoal. A wooden desk in the lower third with a mug and a folded newspaper; on the wall above it, centred, a large
