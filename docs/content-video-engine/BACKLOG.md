...
| **R26-24** | **N-tier pages (small multiples, shared x)** - the macro-chart intake's Archetype 3: three bands, one x, one unit each, so correlated macro series compare without a dual axis. We built the two-band case (`tiers`); the general form is a list of bands with a builder each | macro-chart intake 2026-09-07 (MC-7) | a bounded slice on the tier code: half a day |
