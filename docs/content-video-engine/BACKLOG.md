...
| ME-BL-04 | Resolve the saved fight-shorts rim/transition needle | 🟡 Partial; source mapped, repair pending | Modeling lane; trigger: T5a.8 source map and T5a.12 rejected even-offset control | Repair the local source polygon-40/382 overlap and Solidify rim/offset interaction without T5a.12's 12/11 new flipped triangles or 12 new self-overlap pairs. Recheck neutral, 90° knee, native/phone silhouette and body clearance; reconcile exchange fixture/clock hashes and missing raw video before judging the private light-shorts copy. Do not change the saved asset until geometry and view gates pass. | [Model-engine plan T5a.6–T5a.12](../../.claude/PRPs/plans/SHARED-MODEL-ENGINES.plan.md); ignored `artifacts/t5a12/T5A12-RESULTS.md` in `codex/model-garment-stress` |
