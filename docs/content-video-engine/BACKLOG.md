...
| **R26-26 EXPLORE** | **The divergence spread (two lines, the gap filled, terminal tags)** - the intake's Archetype 4. New to us; our `decline` builder is single-series. The Meta-yield beat ("a higher yield discounts it") is the candidate | macro-chart intake 2026-09-07 (MC-8) | explore first: one page, judged by eye |
