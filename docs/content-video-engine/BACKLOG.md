...
| ME-BL-04 | Resolve the saved fight-shorts rim/transition needle | 🟡 Partial; source mapped, repair pending | Modeling lane; trigger: T5a.8 source map, T5a.9 even-offset sensitivity and visible fin in the exchange proof | Resolve the local nonadjacent overlap candidate near source polygon 40/382 and the Solidify even-offset amplification before proposing a source/stack change. Test neutral, 90° knee and exchange views; require a closed evaluated shell, no new flipped/sliver faces, defensible body clearance and native/phone silhouette improvement before changing the saved asset. Exchange white shorts are a private recolored mesh copy, not an independent source garment. | [Model-engine plan T5a.6–T5a.9](../../.claude/PRPs/plans/SHARED-MODEL-ENGINES.plan.md); ignored `content/video_engine/review/model-engines/benchmark-v1/3d/garment-stress/garment-stack-comparison-r1/source-repair-r1/T5A9-SOURCE-REPAIR-REPORT.md` |
