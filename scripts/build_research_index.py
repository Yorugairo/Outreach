...
RULES = [
 ...
 ("10_", r"Executive Overview", "EXTRACTED -> 49 - the triad map this read followed"),
 ("10_", r"Model Taxonomy|Clarifications", "EXTRACTED -> 49 SS49.2 - no standalone Wan I2V 1.3B; consumer runs Fun-InP or VACE"),
 ("10_", r"Rectified Flow|Mathematical Foundations", "RECORD - why 20-30 steps suffice; the dial is what we use"),
 ("10_", r"DiT Architecture|Causal Wan-VAE", "EXTRACTED -> 49 SS49.2 - the 4k+1 frame law"),
 ("10_", r"Dual Conditioning", "RECORD - umT5 + CLIP-Vision fusion; internal"),
 ("10_", r"Acceleration & VRAM", "EXTRACTED -> 49 SS49.2 - TeaCache 0.15, ~2.2x"),
 ("10_", r"Calibrated Dials & Failure Fixes", "EXTRACTED -> 49 SS49.2 - incl. the two that fail loudly: unscaled FP8 text encoder, quantized VAE"),
 ("10_", r"Architecture & Spatio-Temporal Attention", "RECORD - 3D RoPE; why LTX takes arbitrary aspect ratios"),
 ("10_", r"8n \+ 1|Frame Rule", "EXTRACTED -> 49 SS49.3"),
 ("10_", r"Spatio-Temporal Guidance|STG", "EXTRACTED -> 49 SS49.3 - layer-19 skip is the anti-melt mechanism"),
 ("10_", r"Mask-Pinned Inpainting", "EXTRACTED -> 49 SS49.3 - timestep clamp freezes latents bit-for-bit; how atmosphere moves while numbers cannot drift"),
 ("10_", r"Calibrated Dials & Benchmarks", "EXTRACTED -> 49 SS49.3"),
 ("10_", r"Depth Anything V2", "EXTRACTED -> 49 SS49.4 - preserves the washi deckle edge"),
 ("10_", r"DepthCrafter", "EXTRACTED -> 49 SS49.4 - video depth, fixes flicker and affine drift"),
 ("10_", r"Depthflow-Nodes Mastery|Bug Resolution", "EXTRACTED -> 49 SS49.5 - cites the same file:lines I read from source; three-way agreement"),
 ("10_", r"Geometry-Locked", "EXTRACTED -> 49 SS49.4 - the real answer to character drift under motion"),
 ("10_", r"Mobile UI Safe Zones", "EXTRACTED -> 49 SS49.1 - AND EXPOSED A LIVE DEFECT in our 9:16 dock CSS"),
 ("10_", r"Aspect Ratio Transformation", "EXTRACTED -> 49 SS49.1 - 68.36% area loss; re-stage, never crop"),
 ("10_", r"Short-Form vs. Long-Form", "EXTRACTED -> 49 SS49.6 - visual pulse 1.2-2.5s vs ASL 6-10s; different engines"),
 ("10_", r"Blueprint|Production Code", "RECORD - dual-format Root.tsx and the affine remap; read at build time"),
 ("10_", r"Cross-Model Capability|Engineering Directives", "EXTRACTED -> 49 SS49.2/SS49.3 - the summary matrix"),
 ("10_", r"Depth & Spatial Geometry|Wan 2.1|LTX-Video|Cross-Platform Architecture", "RECORD - structural heading"),
