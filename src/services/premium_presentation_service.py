...
class PremiumPresentationService:
  ...
  <div class="slide-content"><div class="eyebrow reveal">{escape(eyebrow)}</div><div class="split reveal"><div class="stack"><h2 id="title-{number}">{escape(title)} <span class="accent">{escape(accent)}</span></h2><p class="lede">{safe_body}</p></div><div class="stack">{extra}</div></div></div></section>'''
    ...
    def _ai_slide(self, target: dict[str, Any]) -> str:
        ai = self._fmt(target.get("ai_score"))
        return self._slide(5, "AI readiness · what prospects experience", "Make Nova the answer", "when students search", "Parents, beginners, and experienced athletes are already asking Google what to do next. Clear answers about programs, fit, schedule, location, and first steps help those searches turn into visits—not just impressions.", f"<div class=\"score-orbit\"><div class=\"score-main\"><strong>{escape(ai)}</strong><span>AI READINESS</span></div></div><div class=\"card-grid\"><article class=\"card\"><h3>AEO · Answers</h3><span class=\"card-num\">39</span><p>Answer the questions that decide who books a first class.</p></article><article class=\"card\"><h3>GEO · Trust</h3><span class=\"card-num\">100</span><p>Make the academy, coaches, and proof easier to trust.</p></article><article class=\"card\"><h3>AIO · Access</h3><span class=\"card-num\">78</span><p>Keep every important program easy to crawl and reach.</p></article></div>")
