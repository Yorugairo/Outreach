...
4. Route exact microtasks to `speedster`, bounded moderate implementation to
   `implementation_luna`, planning to `architect_sol`, and reviewed Git
   mechanics to `release_steward`.
