...
- Evidence: R26-218/219 (wave 6), R26-221/223 (wave 8), R26-228 + R26-205 (wave 9), R26-226 (wave 10), R26-232 + R26-233 (wave 12), R26-234 (wave 13) - each with tests, goldens byte-identical, reviewed; the 30 s bed rebuilt on all of them (`build-h-frozen-g/`, HG3). Still owed before the body: R26-220 (focus_zoom fixed 1.32 at 16:9 / the caption under a camera key R26-201), R26-230 (the bands - after the operator's caption answer), R26-222, R26-231 (informational), R26-224/225 (the suite's hygiene)
