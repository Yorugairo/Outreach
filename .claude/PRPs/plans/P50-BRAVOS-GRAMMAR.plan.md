...
- Status: built 2026-09-12 - gate 3 GRANTED 2026-09-11 (night): "Plate order is approved."; the three stills driven through the Flow session at zero credit on 2026-09-12 (`art-embed-study-poster`, `art-embed-study-tv-laptop` - frames approved: "The frames are fine"; `art-embed-washi-tv` - ordered on "order it", its still QUARANTINED pending the operator's frame read); the mechanism WIRED against the measured quads (`measure_embed_quads.py`; `kinetics/homography.mjs`; `embedPlace`; the camera target `{kind: "embed"}`) and E66 the same day (the card fills its surface, reflowed by `pressTypeScale` / `pressPictureFit`; a screen surface displays it - the sheen, the edge falloff, the lift; `kind` and `sheen` on the layers file). **Direction replaced 2026-09-14 (E99 s28):** the washi still is RETIRED (its "soft deckle" painted a torn edge and its paper read too white, `#F9F5E9`); the operator's five split plates are the direction - a TV over a generated cream panel, a cream TV over a generated charcoal board, a cream TV over a desk, and a cream TV over a laptop twice - each seam a straight wooden shelf, their generated cream and charcoal kept as painted (no hex fill; the colour target is the build-f generated page). **Frames read 2026-09-14 (E99 s29):** four approved - split-tv-paper, split-tv-charcoal, split-tv-desk, dual-tv-laptop-2 - and dual-tv-laptop-1 turned down. Open on the operator's side: their read of the fill/sheen crops. The pulled phrase as live type is R26-55.
- Owner: parent
- Depends on: T3
