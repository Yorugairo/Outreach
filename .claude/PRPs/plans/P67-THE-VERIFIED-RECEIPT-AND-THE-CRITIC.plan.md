...
- Status: running (the receipt and the critic done, the card carries both; the `CRITIC_REQUIRED` flip waits for P66's base to have its own critic - the other live whole-cut card)
- Owner: parent
