...
export const meltPitchShare = (secs, o = {}) => {
  const P = Object.assign({}, MELT, o), s = Math.max(0.05, +secs || P.S);
...
export const meltRestShare = (secs, o = {}) => 1 - meltWeightShare(secs, o) - meltPitchShare(secs, o);
...
export const meltLandingAt = (sb, o = {}) => {
...
export const meltPitchAt = (tw, tsecs, r, to, o = {}) => {
