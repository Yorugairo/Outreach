...
PROOF_FRAMES = {
    ...
    # at 2.0 / 3.5 / 5.0 / 6.4 / 7.8 / 9.2 / 10.6 / 12.2 / 13.8 with clear_at 16.5. The MOSAIC is the base golden
    # (FRAME_T 13.6). No flag: a surface's aspect is authored on its timeline, not switched on.
