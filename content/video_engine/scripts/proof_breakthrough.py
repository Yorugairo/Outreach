...
def main() -> int:
    ...
    scene = dict(tl["scenes"][0], species=[], span=[0.0, RUNTIME], world=dict(world, ken_burns={"scale": 0, "x": 0, "y": 0}))
    timeline = dict(tl, aspect="9:16", runtime_s=RUNTIME, scenes=[scene], caption_pages=[], captions=[],
                    title="The breakthrough: bonds 1.52 % a year vs chips 36.59 % a year, the scale stated to 8 %")
