# SCRIPT GATES - SCRIPT-90S-VO.v1-current-lead.txt

script: SCRIPT-90S-VO.v1-current-lead.txt
generated: 2026-09-04T01:10:22+00:00
script_hash: f8d1ffa32b226bc4bef6565c8905359d94cb0feb4a17d321cf95b9b6021cf5b0
timing_source: estimated

TOOLS      lint: exit 0, 0 fails | audit: exit 0, 0/1, timing=estimated |
           opening gate: exit 1, 17/0/24/7 | screens: SCRIPT-90S.v1-current-lead-SCREENS.md, 14 items
...
```
stats: {'sentence_mean': 9.5, 'sentence_count': 30, 'word_count': 285, 'rehook_positions_pct': [21, 53, 54, 60]}
RESULT: clean
```
...
```
=== SCRIPT-90S-VO.v1-current-lead.txt ===
             chars: 1607
         runtime_s: 99.4
           runtime: 1m 39s
         sentences: 30
     sentence_mean: 9.5
      break_ration: 0.62
  sentence_mean_carrying: 10.5
  short_figure_share: 13.3%
    sentence_stdev: 5.6
     over_20_share: 6.7%
       hook_spread: 12%
   hook_properties: present-tense=y, viewer-facing=n
       ...
       first_you_s: 5.8
         cta_count: 0
           rehooks: ['0.3m', '0.9m', '0.9m', '1.0m']
         phase_map: {'P1 OPEN': '0.0-0.2m', 'P2 ENGINE': '0.2-1.5m', 'P3 GAP': '0.3-0.7m', 'P4 PIVOT': '0.7-0.9m', 'P5 REFLECTION': '0.9-1.4m', 'P6 CLOSE': '0.2-1.7m'}
  p3_units_expected: 1
         a3_anchor: 0:09
         pivot_pct: None
  ...
  [INFO] estimator: the two rate estimates disagree by 12% on the first sentence (numerals read longer than they look) — record a take to settle it
  [INFO] doc 38 B1-B4: owned by gate_opening_structure - see content\video_engine\projects\systems-and-blowups\tokyo-tea-break\SCRIPT-90S.v1-current-lead-GATES.md
...
```
=== OPENING STRUCTURE GATE: SCRIPT-90S-VO.v1-current-lead.txt ===
           runtime: 1:38
     ...
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:09
             cycle: checked 0:00-1:38; longest gap 20s from 0:24
      unit_windows: ['P3 unit 1 0:16-0:44', 'P5 unit 2 0:54-1:25']
      counterparty: Tokyo
              ring: tea break
    ...
    beats_declared: {'archetype': ['0:07'], 'stakes': ['0:18'], 'rehook': ['0:20', '0:53'], 'payoff': ['0:24'], 'promise': ['0:45'], 'ring': ['0:56', '1:32'], 'opponent': ['0:59'], 'loop-close': ['1:15'], 'tricolon': ['1:30']}
  ...
  [FAIL ] G29 no dip within 15s of the macro close at 1:15
  ...
  [PASS ] G01 first sentence 2.25s
          PLATFORM 3s microhook (38 B1 / P1 QC)
  [PASS ] G03 paid at 5.69s, settle at 5.69s
  ...
  [PASS ] G11 'By the end of this minute, you'll know the one number that decides whe'
  ...
  [PASS ] G36 longest stretch without a cycle beat: 20s from 0:24
          CLK the cycle repeats per beat - hook / show it's worth it / promise more / deliver; no >60s without a cycle beat, 0:00-1:38 (E23: whole runtime)
  ...
  [JUDGE] J03 'US bond yields crossed critical levels.'
  ...
  [JUDGE] J05 'US bond yields crossed critical levels.' -> 'But the Federal Reserve didn't move an inch this m'
  ...
  [JUDGE] J12 no --thumb-file given - open the FINAL thumbnail; sentence 1: 'US bond yields crossed critical levels.'
          E24 / doc 29 s9.29: the first sentence answers what the thumbnail poses - open the thumbnail and read sentence 1 against it

RESULT: 17 FAIL / 0 WARN / 24 PASS / 7 JUDGE (read these) / 2 INFO
```
...
```
SCRIPT-90S.v1-current-lead-SCREENS.md: X1=5 deixis=1 junctions=1 anchors=7 declared=11
```
