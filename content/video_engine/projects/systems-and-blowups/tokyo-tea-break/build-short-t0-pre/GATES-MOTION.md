...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\tokyo-tea-break\build-short-t0 ===
  ...
  [INFO ] M25 layout-probe.json measured another player.html (the build was rebuilt since) - re-run probe.py <build> --gate
  ...
  [INFO ] M26 layout-probe.json measured another player.html (the build was rebuilt since) - re-run probe.py <build> --gate
...
RESULT: 0 FAIL / 2 WARN / 15 PASS / 1 JUDGE / 6 INFO
```

TIMELINE: tokyo-short.timeline.json sha256:995ce53a3a49a3105f1d82de1499c494bb73eab31dc43620eab747411bfc74b4
VERDICT: PASS (0 FAIL)
