...
generated: 2026-09-05T05:24:50+00:00
script_hash: be0ebc192fb8a171cd672fcdb2dbb70871f9884e8acee7a3dada73f7abdb775a
timing_source: estimated

TOOLS      lint: exit 0, 0 fails | audit: exit 0, 0/1, timing=estimated |
           opening gate: exit 1, 3/2/40/10 | screens: SCRIPT-90S.claude-SCREENS.md, 8 items
...
```
stats: {'sentence_mean': 10.2, 'sentence_count': 27, 'word_count': 276, 'rehook_positions_pct': [17, 74]}
RESULT: clean
```
...
=== OPENING STRUCTURE GATE: SCRIPT-90S-VO.claude.txt ===
     ...
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:09
             cycle: checked 0:00-1:34; longest gap 18s from 1:13
      unit_windows: ['P3 unit 1 0:16-0:42', 'P5 unit 2 0:51-1:21']
      counterparty: Japan
              ring: tab
    ...
    beats_declared: {'stakes': ['0:04'], 'archetype': ['0:07'], 'tricolon': ['0:07'], 'rehook': ['0:15', '0:39', '1:08'], 'payoff': ['0:19'], 'new': ['0:19', '0:42', '0:48', '1:03'], 'reflect': ['0:26'], 'opponent': ['0:31'], 'desire': ['0:35'], 'map': ['0:35'], 'promise': ['0:39'], 'catalyst': ['0:42'], 'loop': ['0:48', '1:03'], 'foreshadow': ['0:48'], 'loop-close': ['1:08'], 'dip': ['1:13'], 'signpost': ['1:13'], 'ring': ['1:31']}
  ...
  [PASS ] G36 longest stretch without a cycle beat: 18s from 1:13
          CLK the cycle repeats per beat - hook / show it's worth it / promise more / deliver; no >60s without a cycle beat, 0:00-1:34 (E23: whole runtime)
...
```
SCRIPT-90S.claude-SCREENS.md: X1=3 deixis=0 junctions=1 anchors=4 declared=24
```
