  ...
  short_figure_share: 10.7%
   ...
   hook_properties: present-tense=y, viewer-facing=n
       ...
       first_you_s: 6.0
         cta_count: 0
           rehooks: ['0.3m', '1.0m']
         phase_map: {'P1 OPEN': '0.0-0.2m', 'P2 ENGINE': '0.2-1.5m', 'P3 GAP': '0.3-0.8m', 'P4 PIVOT': '0.8-1.0m', 'P5 REFLECTION': '1.0-1.5m', 'P6 CLOSE': '0.3-1.8m'}
  p3_units_expected: 1
         a3_anchor: 0:10
         pivot_pct: None
     timing_source: estimated (no take on disk)

  [WARN] MAP sec 1: P1 computes to 14s; the open is pinned 60-90s at every runtime
...
=== OPENING STRUCTURE GATE: SCRIPT-90S-VO.claude.txt ===
  ...
  [WARN ] G43 0/3 declared beats open on a gap/consequence connector
  ...
  [PASS ] G36 longest stretch without a cycle beat: 35s from 1:06
          CLK the cycle repeats per beat - hook / show it's worth it / promise more / deliver; no >60s without a cycle beat, 0:00-1:44 (E23: whole runtime)
