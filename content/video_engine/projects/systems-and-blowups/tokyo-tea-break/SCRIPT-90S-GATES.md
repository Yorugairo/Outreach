...
```
stats: {'sentence_mean': 8.9, 'sentence_count': 31, 'word_count': 277, 'rehook_positions_pct': [14, 33]}
RESULT: clean
```
...
=== OPENING STRUCTURE GATE: SCRIPT-90S-VO.txt ===
     ...
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:09
             cycle: checked 0:00-1:34; longest gap 31s from 0:56
    ...
    beats_declared: {'archetype': ['0:05'], 'stakes': ['0:10'], 'rehook': ['0:12', '0:56'], 'payoff': ['0:16'], 'promise': ['0:22'], 'head-fake': ['0:31'], 'debate': ['0:39'], 'loop-close': ['0:44'], 'ring': ['0:48', '1:29'], 'opponent': ['0:51'], 'tricolon': ['1:26']}
  ...
  [WARN ] G09 promise at 0:22 - before the mini-payoff window opens
          F1 + A1 + macro-loop-1 SETUP: the dated promise in 0:30-0:45 (38 B4 / MAP s3 / CLK; E24 roadmap by 0:45)
  [PASS ] G01 first sentence 1.08s
          PLATFORM 3s microhook (38 B1 / P1 QC)
  [PASS ] G03 paid at 5.99s, settle at 5.99s
  ...
  [JUDGE] J05 'Your costs jumped.' -> 'Bond yields crossed critical levels this month, an'
  ...
  [JUDGE] J12 no --thumb-file given - open the FINAL thumbnail; sentence 1: 'Your costs jumped.'
