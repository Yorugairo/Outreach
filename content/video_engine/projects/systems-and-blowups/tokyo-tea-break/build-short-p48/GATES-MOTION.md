# MOTION GATE — build-short-p48

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\tokyo-tea-break\build-short-p48 ===
               runtime: 1:28
         visual_events: 310 (209.4/min)
                 docks: 5
           dock_source: timeline
          ledger_pages: 4
  still_over_12s_share: 0%
            per_minute: 0:00:218/5 1:00:189/8
  ...
  [INFO ] M07 short: 1 full minute(s) in 89s - opening 218.0 events/min, 5.0 evidence entries/min; tail from 1:00 189.4/min; whole runtime 208.1/min - no minute distribution to rank in (E21 is judged on the whole)
...
TIMELINE: tokyo-short.timeline.json sha256:2bf9883e9d6709a96cce8be8266f40a310dd7a723d6998bdb40949c7dbfe7afd
VERDICT: PASS (0 FAIL)
