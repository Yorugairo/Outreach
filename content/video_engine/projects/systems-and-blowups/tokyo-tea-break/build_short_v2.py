...
- Recall(voice): content/video_engine/projects/systems-and-blowups/tokyo-tea-break/REBUILD-TREATMENT-V2.md:56 "The take (`scene_1-tight`), the script, the caption pages" (the recorded take stands as recorded; every instant here is measured off it)
