# MOTION GATE — build-v2

```text
=== MOTION DENSITY GATE: content\video_engine\projects\systems-and-blowups\tokyo-tea-break\build-v2 ===
               runtime: 1:28
  ...
  still_over_12s_share: 0%
            per_minute: 0:00:227/6 1:00:173/10
  ...
  [WARN ] M27 1 card(s) inside the plot's box, clear of its ink, over 78 instants probed: dock-g-two-fingers is inside the plot's box, clear of the ink, on the finished chart, at 0:36, 16,297 px, 13 % of the smaller box (marks 100% drawn) - E65's own placement; listed so the author sees where the read landed
  ...
  [WARN ] M44 1 world plate(s) under 6s (1 world plate(s), floor 6s): s03 5.9s - a plate the eye cannot take in; lengthen it or fold it into its neighbour
  ...
  [PASS ] M23 10 transition(s), each on a built chart and clear of its page's edge: s02 park 0:08+0.9s, s02 rescale 0:21+1.4s, s02 park 0:36+0.9s, s02 park 0:20+0.5s, s04 park 0:54+0.9s, s04 recast 0:50+1.4s, s04 recast 0:56+0.5s, s04 park 0:59+0.9s, s04 park 1:06+0.9s, s05 park 1:14+0.9s
  ...
  [PASS ] M25 no settled card on the chart's data, on a line of the page's ink or in the caption strip over 78 instants probed; smallest type read 11.6 CSS px on a phone (floor 11) | INFO, listed not scored (CSS px on a phone): source parked 3.4, pill parked 4.5, chart.lab parked 5.3, sub parked 5.3
  ...
  [PASS ] M26 79 printed value(s) over 78 instants probed agree with the height drawn on the scale the page prints (band 4% of the top tick + the burst's 5% overshoot); worst 2.9% of the top tick - May at 0:56
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 78 instants probed (3,565 label pair(s) checked)
  ...
  [PASS ] M34 no mark over a text box and no text box on a line it does not name over 78 instants probed (617 pair(s) checked)
  ...
  [INFO ] M07 short: 1 full minute(s) in 89s - opening 227.0 events/min, 6.0 evidence entries/min; tail from 1:00 172.8/min; whole runtime 208.7/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M20 4 arrival(s): dock-c-blue-ties-panel throw ~1583 px/s -> on 1s; dock-g-two-fingers land (metal) - weight sold 0.32s before the impact; dock-l-meta-phone throw ~1488 px/s -> on 1s; dock-h-fed-vs-yields throw ~1188 px/s -> on 1s
...
TIMELINE: tokyo-short.timeline.json sha256:075a22db62af6810fe10dde734483e9769977f6c682bf6c27c73a61cbd6719f8
VERDICT: PASS (0 FAIL)
