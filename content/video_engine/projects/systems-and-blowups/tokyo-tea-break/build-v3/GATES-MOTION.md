# MOTION GATE — build-v3

```text
=== MOTION DENSITY GATE: content\video_engine\projects\systems-and-blowups\tokyo-tea-break\build-v3 ===
               runtime: 1:28
  ...
  still_over_12s_share: 0%
            per_minute: 0:00:211/7 1:00:173/10

  [FAIL ] M27 1 card(s) reading over a ledger page's ink over 77 instants probed: dock-c-blue-ties-panel reads on the chart's data on the finished chart, at 0:09, 2,432 px, 4 % of the smaller box (marks 52% drawn) - move the READ, never the word (E63): a free band at the reading scale, else the plot's own empty room (E65), else the scale that fits
  ...
  [WARN ] M04 6 distinct plates; target runtime/12s = 7
          doc 29 s9.13 plate density
  [WARN ] M06 60 caption pages = 41/min, 3.9 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [WARN ] M21 1 page(s) deployed past 12s after the last data mark: s01 16.5s (0:22 -> 0:38) - un-draw it (undraw) or let it become the next thing (figure, another display, the morph)
  ...
  [WARN ] M44 1 world plate(s) under 6s (1 world plate(s), floor 6s): s02 5.9s - a plate the eye cannot take in; lengthen it or fold it into its neighbour
  ...
  [PASS ] M05 2 plate(s) over the 20s hold, every one LIVE across it (worst gap 1.6s of 2.5s allowed)
  ...
  [PASS ] M11 first chart ledger:s01 enters at 0.0s, its build lands at 3.0s, with build_to landing on datum 311 at 3.0s (the cap is the annotation: the line ends on the datum); window 0-10s (E44 short: the page rolls out on the hook - the chart is the mechanism by 0:10)
  ...
  [PASS ] M23 9 transition(s), each on a built chart and clear of its page's edge: s01 rescale 0:21+1.4s, s01 park 0:36+0.9s, s01 park 0:20+0.5s, s03 park 0:54+0.9s, s03 recast 0:50+1.4s, s03 recast 0:56+0.5s, s03 park 0:59+0.9s, s03 park 1:06+0.9s, s04 park 1:14+0.9s
  ...
  [PASS ] M25 no settled card on the chart's data, on a line of the page's ink or in the caption strip over 77 instants probed; smallest type read 11.6 CSS px on a phone (floor 11) | INFO, listed not scored (CSS px on a phone): source parked 3.4, pill parked 4.5, chart.lab parked 5.3, sub parked 5.3
  ...
  [PASS ] M26 79 printed value(s) over 77 instants probed agree with the height drawn on the scale the page prints (band 4% of the top tick + the burst's 5% overshoot); worst 2.9% of the top tick - May at 0:56
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 77 instants probed (3,544 label pair(s) checked)
  ...
  [PASS ] M29 1 transient cue(s) inside the drop window, each with a page or dock landing on it: landing 1 (throw, paper) at 9.51s gain 0.12 with s01 dock dock-c-blue-ties-panel throw lands at 9.55s (window 0:05-0:12, E44 s2a: the press cue at a cut is not a hook device)
  ...
  [PASS ] M34 no mark over a text box and no text box on a line it does not name over 77 instants probed (593 pair(s) checked)
  ...
  [INFO ] M07 short: 1 full minute(s) in 89s - opening 211.0 events/min, 7.0 evidence entries/min; tail from 1:00 172.8/min; whole runtime 197.9/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M19 1 build_to hold(s) - the line rests at a datum until the next word: 0:03+15.9s
          P47 T2 (SHOT-TABLE-V3-PROPOSAL part B): a cap is a hold the sentence asked for, not stillness
  [INFO ] M20 4 arrival(s): dock-c-blue-ties-panel throw ~1203 px/s -> on 1s; dock-g-two-fingers land (metal) - weight sold 0.32s before the impact; dock-l-meta-phone throw ~1488 px/s -> on 1s; dock-h-fed-vs-yields throw ~1188 px/s -> on 1s
...
RESULT: 1 FAIL / 4 WARN / 19 PASS / 1 JUDGE / 7 INFO
```

TIMELINE: tokyo-short.timeline.json sha256:a2475d2afd8932356df3262e5fdde587ddfd04fa5e78f9a2993ba5c8b18a221d
VERDICT: FAIL (1 FAIL)
