...
=== MOTION DENSITY GATE: projects\systems-and-blowups\tokyo-tea-break\build-short ===
  ...
  still_over_12s_share: 0%
            per_minute: 0:00:217/6 1:00:181/8
  ...
  [PASS ] M01 longest still stretch 1.3s at 1:00
  ...
  [PASS ] M16 longest gap between visual events 1.3s at 1:00; 0 gap(s) over 2.5s
  ...
  [PASS ] M21 every ledger page leaves or un-draws within 8s of its last data mark: s02 0.9s (0:20 -> 0:21); s04 1.2s (0:49 -> 0:50); s05 5.9s (1:10 -> 1:16); s06 3.8s (1:18 -> 1:22)
  ...
  [INFO ] M07 short: 1 full minute(s) in 89s - opening 217.0 events/min, 6.0 evidence entries/min; tail from 1:00 181.1/min; whole runtime 204.7/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M20 4 arrival(s): dock-c-blue-ties-panel throw ~1188 px/s -> on 1s; dock-g-two-fingers land (metal) - weight sold 0.32s before the impact; dock-i-japan-selling throw ~1916 px/s -> on 1s; dock-h-fed-vs-yields throw ~1386 px/s -> on 1s
...
TIMELINE: tokyo-short.timeline.json sha256:b4013d1786c2bc013c7987c3952318710ad42ee7a18d3ef4492b6f1679cbf22d
VERDICT: PASS (0 FAIL)
