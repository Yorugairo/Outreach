# Publish checklist - Tokyo Tea Break (Money Physics) - `build-short-t16`

9:16 - 1:29 - every step below is a HUMAN's. The package is written from the build's own artifacts; scheduling and API posting are out of scope (R26-8).
