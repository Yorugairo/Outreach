# SCRIPT GATES - SCRIPT-90S-VO.v2-proposal.txt

script: SCRIPT-90S-VO.v2-proposal.txt
generated: 2026-09-04T01:10:22+00:00
script_hash: a16c170732f5e29f2d05cbfb337d94ee733218c29791d1eb6711f2e82cedec7b
timing_source: estimated

TOOLS      lint: exit 0, 0 fails | audit: exit 0, 0/1, timing=estimated |
           opening gate: exit 1, 17/0/24/7 | screens: SCRIPT-90S.v2-proposal-SCREENS.md, 13 items
...
```
stats: {'sentence_mean': 9.8, 'sentence_count': 29, 'word_count': 284, 'rehook_positions_pct': [21, 53, 53, 60]}
RESULT: clean
```
...
=== SCRIPT-90S-VO.v2-proposal.txt ===
  ...
  [INFO] doc 38 B1-B4: owned by gate_opening_structure - see content\video_engine\projects\systems-and-blowups\tokyo-tea-break\SCRIPT-90S.v2-proposal-GATES.md
...
```
=== OPENING STRUCTURE GATE: SCRIPT-90S-VO.v2-proposal.txt ===
           runtime: 1:38
    ...
    beats_declared: {'archetype': ['0:06'], 'stakes': ['0:17'], 'rehook': ['0:20', '0:52'], 'payoff': ['0:24'], 'promise': ['0:45'], 'ring': ['0:56', '1:32'], 'opponent': ['0:59'], 'loop-close': ['1:14'], 'tricolon': ['1:30']}
  ...
  [FAIL ] G29 no dip within 15s of the macro close at 1:14
...
```
SCRIPT-90S.v2-proposal-SCREENS.md: X1=4 deixis=1 junctions=1 anchors=7 declared=11
```
