# CARRIED FROM COPY e - the director-critic's ONE read of the bed (E99 s82 (c)); copy g carries: the melt in the cut, the certificate's face (f), the following rescale (R26-233), no interior word walk (s83), the gate crediting the page's life (R26-232). Read on copy e 2026-09-18.
