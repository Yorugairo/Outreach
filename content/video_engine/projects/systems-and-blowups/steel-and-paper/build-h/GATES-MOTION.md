...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\.claude\worktrees\fable-p68\content\video_engine\projects\systems-and-blowups\steel-and-paper\build-h ===
               runtime: 2:42
         visual_events: 422 (155.8/min)
   caption_page_events: 404 from 74 page(s) (50 anchor, 24 stage) + 330 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor, 21 unpinned anchored page(s) not counted (R26-232)
        live_page_life: 58 event(s) every 1.613s inside s01 0:00-0:42, s04 0:56-1:03, s05 1:03-1:44 - the PULSE rows M05/M10/M16 only (R26-232)
                 docks: 7
           dock_source: timeline
          ledger_pages: 3
  still_over_12s_share: 0%
            per_minute: 0:00:180/4 1:00:146/4 2:00:134/3
  ...
  [WARN ] M04 7 distinct plates; target runtime/12s = 13
          doc 29 s9.13 plate density
  [WARN ] M25 2 safe-zone intrusion(s) over 67 instants probed: a card is 19 % inside the bottom safe-zone band at 0:09; a card is 18 % inside the bottom safe-zone band at 0:10
  ...
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M05 3 plate(s) over the 20s hold, every one LIVE across it (worst gap 2.4s of 2.5s allowed)
  ...
  [PASS ] M06 95 caption pages = 35/min, 4.5 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 50 anchor, 24 stage page(s), 330 word arrival(s), 21 unpinned anchored page(s) passed over (R26-232)
  ...
  [PASS ] M16 longest gap between visual events 2.4s at 2:18; 0 gap(s) over 2.5s
  ...
  [PASS ] M18 no run of bit-identical frames over 0.50s (1951 frames at 12 fps, 0:00-2:42); longest 0.00s at 0:00
  ...
  [PASS ] M23 3 transition(s), each on a built chart and clear of its page's edge: s01 rescale 0:28+2.2s, s05 recast 1:20+2.0s, s05 recast 1:33+1.2s; s01 rescale at 0:28 FOLLOWS its line - on the line's own clock, so the over-a-build check does not apply to it (R26-233)
  ...
  [PASS ] M27 no card reads over a ledger page's ink over 67 instants probed (9 not-parked card reading(s) measured)
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 67 instants probed (1,766 label pair(s) checked)
  ...
  [PASS ] M32 6 boundaries read frame by frame: no flash, no jump, no black outside a dip's core
  ...
  [PASS ] M34 no mark over a text box and no text box on a line it does not name over 67 instants probed (5 pair(s) checked)
  ...
  [INFO ] M07 short: 2 full minute(s) in 162s - opening 180.0 events/min, 4.0 evidence entries/min; tail from 1:00 146.0/min; whole runtime 155.1/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M26 no bars page printed a value at any of the 67 instants probed - nothing to check (a line page's numbers are its tags, not a height)
...
RESULT: 2 FAIL / 2 WARN / 22 PASS / 1 JUDGE / 6 INFO
```

TIMELINE: steel-and-paper-h.timeline.json sha256:1dd2401ef7dbda0f77330d2cffa3bd6c069d6a90906d8bc605899fbc8ece4c04
VERDICT: FAIL (2 FAIL)
