...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\.claude\worktrees\fable-p68\content\video_engine\projects\systems-and-blowups\steel-and-paper\build-h ===
               runtime: 3:16
         visual_events: 524 (160.2/min)
   caption_page_events: 513 from 92 page(s) (68 anchor, 24 stage) + 421 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor, 21 unpinned anchored page(s) not counted (R26-232)
        live_page_life: 79 event(s) every 1.613s inside s01 0:00-0:42, s04 0:56-1:03, s05 1:03-1:44, s08 2:42-3:16 - the PULSE rows M05/M10/M16 only (R26-232)
                 docks: 7
           dock_source: timeline
          ledger_pages: 4
  still_over_12s_share: 0%
            per_minute: 0:00:180/4 1:00:146/4 2:00:150/3
  ...
  [WARN ] M04 8 distinct plates; target runtime/12s = 16
          doc 29 s9.13 plate density
  [WARN ] M25 2 safe-zone intrusion(s) over 80 instants probed: a card is 19 % inside the bottom safe-zone band at 0:09; a card is 18 % inside the bottom safe-zone band at 0:10 | INFO, listed not scored (CSS px on a phone): source (the citation) 8.8
  ...
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M05 4 plate(s) over the 20s hold, every one LIVE across it (worst gap 2.4s of 8.0s allowed)
  ...
  [PASS ] M06 113 caption pages = 35/min, 4.6 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M07 opening minute: 180.0 events/min, 4.0 docks/min - rank 3/3 from the bottom; episode median 150.0/min
          E21: the opening is the densest minute, never the thinnest
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 68 anchor, 24 stage page(s), 421 word arrival(s), 21 unpinned anchored page(s) passed over (R26-232)
  ...
  [PASS ] M18 no run of bit-identical frames over 0.50s (2356 frames at 12 fps, 0:00-3:16); longest 0.00s at 0:00
  ...
  [PASS ] M27 no card reads over a ledger page's ink over 80 instants probed (9 not-parked card reading(s) measured)
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 80 instants probed (3,357 label pair(s) checked)
  ...
  [PASS ] M31 no world-taking transition leaves the stage empty (0.6% of the runtime empty)
  ...
  [PASS ] M32 7 boundaries read frame by frame: no flash, no jump, no black outside a dip's core
  ...
  [PASS ] M34 no mark over a text box and no text box on a line it does not name over 80 instants probed (13 pair(s) checked)
  ...
  [INFO ] M19 6 build_to hold(s) - the line rests at a datum until the next word: 0:00+27.8s, 1:04+1.1s, 1:14+3.0s, 1:18+7.8s, 2:43+5.1s, 2:57+2.7s
  ...
  [INFO ] M21 2 page(s) deployed 8-12s after the last data mark (a dock's clip may hold it): s01 11.6s (0:30 -> 0:42); s05 9.8s (1:34 -> 1:44)
  ...
  [INFO ] M26 no bars page printed a value at any of the 80 instants probed - nothing to check (a line page's numbers are its tags, not a height)
...
RESULT: 2 FAIL / 2 WARN / 23 PASS / 1 JUDGE / 5 INFO
```

TIMELINE: steel-and-paper-h.timeline.json sha256:9fed0d8a91740fbd175710d1cc8029a6f43217deb2ec6db4674ab5cee6e62fb7
VERDICT: FAIL (2 FAIL)
