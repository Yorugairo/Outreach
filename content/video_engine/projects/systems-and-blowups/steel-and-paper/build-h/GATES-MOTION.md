...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\.claude\worktrees\fable-p68\content\video_engine\projects\systems-and-blowups\steel-and-paper\build-h ===
               runtime: 4:02
         visual_events: 672 (166.0/min)
   caption_page_events: 683 from 122 page(s) (98 anchor, 24 stage) + 561 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor, 21 unpinned anchored page(s) not counted (R26-232)
        live_page_life: 109 event(s) every 1.613s inside s01 0:00-0:42, s04 0:56-1:03, s05 1:03-1:44, s08 2:42-3:15 - the PULSE rows M05/M10/M16 only (R26-232)
                 docks: 7
           dock_source: timeline
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:180/4 1:00:146/4 2:00:150/3 3:00:190/1

  [FAIL ] M03 longest wait for evidence to enter: 47s from 3:15
  ...
  [FAIL ] M31 1 chart-to-chart transition(s) leave empty cream on stage (0.6% of the runtime empty); worst s08 exit=melt 0.2s at 3:15 - the next page belongs on its axes under the outgoing one (stamp_transition_pages)
  ...
  [WARN ] M04 9 distinct plates; target runtime/12s = 20
          doc 29 s9.13 plate density
  [WARN ] M21 1 page(s) deployed past 12s after the last data mark: s09 17.6s (3:45 -> 4:02) - un-draw it (undraw) or let it become the next thing (figure, another display, the morph)
  ...
  [WARN ] M25 2 safe-zone intrusion(s) over 93 instants probed: a card is 19 % inside the bottom safe-zone band at 0:09; a card is 18 % inside the bottom safe-zone band at 0:10 | INFO, listed not scored (CSS px on a phone): source (the citation) 8.8
  ...
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M05 5 plate(s) over the 20s hold, every one LIVE across it (worst gap 2.4s of 8.0s allowed)
  ...
  [PASS ] M06 143 caption pages = 35/min, 4.6 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M07 opening minute: 180.0 events/min, 4.0 docks/min - rank 3/4 from the bottom; episode median 165.0/min
          E21: the opening is the densest minute, never the thinnest
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 98 anchor, 24 stage page(s), 561 word arrival(s), 21 unpinned anchored page(s) passed over (R26-232)
  ...
  [PASS ] M18 no run of bit-identical frames over 0.50s (2915 frames at 12 fps, 0:00-4:02); longest 0.00s at 0:00
  ...
  [PASS ] M23 4 transition(s), each on a built chart and clear of its page's edge: s01 rescale 0:28+2.2s, s05 recast 1:20+2.0s, s05 recast 1:33+1.2s, s08 recast 3:05+1.2s; s01 rescale at 0:28 FOLLOWS its line - on the line's own clock, so the over-a-build check does not apply to it (R26-233)
  ...
  [PASS ] M27 no card reads over a ledger page's ink over 93 instants probed (9 not-parked card reading(s) measured)
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 93 instants probed (4,157 label pair(s) checked)
  ...
  [PASS ] M32 8 boundaries read frame by frame: no flash, no jump, no black outside a dip's core
  ...
  [PASS ] M33 2 pointing phrase(s), each with a page, dock or card on stage
  ...
  [PASS ] M34 no mark over a text box and no text box on a line it does not name over 93 instants probed (13 pair(s) checked)
  ...
  [INFO ] M19 10 build_to hold(s) - the line rests at a datum until the next word: 0:00+27.8s, 1:04+1.1s, 1:14+3.0s, 1:18+7.8s, 2:43+5.1s, 2:57+2.7s, 3:16+2.2s, 3:26+3.9s
          P47 T2 (SHOT-TABLE-V3-PROPOSAL part B): a cap is a hold the sentence asked for, not stillness
  [INFO ] M20 7 arrival(s): dock-h-certificate-1845 throw ~1103 px/s -> on 1s; dock-h-two-line-copy throw ~2016 px/s -> on 1s; dock-h-sell-ticket throw ~1432 px/s -> on 1s; dock-h-karp-record throw ~3284 px/s -> on 1s; dock-h-uber-adoption land (paper) - weight sold 0.32s before the impact; dock-h-coo-line land (paper) - weight sold 0.32s before the impact; dock-h-three-manias land (paper) - weight sold 0.32s before the impact
  ...
  [INFO ] M26 no bars page printed a value at any of the 93 instants probed - nothing to check (a line page's numbers are its tags, not a height)
...
RESULT: 3 FAIL / 3 WARN / 22 PASS / 1 JUDGE / 4 INFO
```

TIMELINE: steel-and-paper-h.timeline.json sha256:46bc0784b7ed614c2b2ef29e22323ff226d4bb31ebddd7f8699f0d3d93413ac7
VERDICT: FAIL (3 FAIL)
