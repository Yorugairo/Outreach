...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\.claude\worktrees\fable-p68\content\video_engine\projects\systems-and-blowups\steel-and-paper\build-h ===
               runtime: 1:03
         visual_events: 170 (159.9/min)
   caption_page_events: 184 from 33 page(s) (24 anchor, 9 stage) + 151 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor, 4 unpinned anchored page(s) not counted (R26-232)
  ...
  [WARN ] M04 3 distinct plates; target runtime/12s = 5
          doc 29 s9.13 plate density
  [WARN ] M25 2 safe-zone intrusion(s) over 22 instants probed: a card is 19 % inside the bottom safe-zone band at 0:09; a card is 18 % inside the bottom safe-zone band at 0:10
  ...
  [PASS ] M01 longest still stretch 2.5s at 0:56
  ...
  [PASS ] M06 37 caption pages = 35/min, 4.5 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 24 anchor, 9 stage page(s), 151 word arrival(s), 4 unpinned anchored page(s) passed over (R26-232)
  ...
  [PASS ] M16 longest gap between visual events 2.5s at 0:56; 0 gap(s) over 2.5s
  ...
  [PASS ] M18 no run of bit-identical frames over 0.50s (766 frames at 12 fps, 0:00-1:03); longest 0.00s at 0:00
  ...
  [PASS ] M27 no card reads over a ledger page's ink over 22 instants probed (5 not-parked card reading(s) measured)
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 22 instants probed (789 label pair(s) checked)
  ...
  [INFO ] M07 short: 1 full minute(s) in 64s - opening 168.0 events/min, 3.0 evidence entries/min; whole runtime 158.1/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M20 2 arrival(s): dock-h-certificate-1845 throw ~1103 px/s -> on 1s; dock-h-two-line-copy throw ~1765 px/s -> on 1s
  ...
  [INFO ] M26 no bars page printed a value at any of the 22 instants probed - nothing to check (a line page's numbers are its tags, not a height)
  ...
  [INFO ] M34 no text box met a mark or a series line at any of the 22 instants probed - nothing to check
...
RESULT: 2 FAIL / 2 WARN / 18 PASS / 1 JUDGE / 10 INFO
```

TIMELINE: steel-and-paper-h.timeline.json sha256:4ac64d0c0ffd5bcfce6e44d78d41ac80c6f24e49d7e4673aaa321fe60b6b9008
VERDICT: FAIL (2 FAIL)
