...
generated: 2026-09-08T08:31:23+00:00
script_hash: 87823cc927a53bc292a16843bdf4f59a2e77487d3de3edb61cdcbba63000a921
timing_source: measured

TOOLS      lint: exit 0, 0 fails | audit: exit 0, 0/0, timing=estimated |
           opening gate: exit 1, 6/2/38/12 | screens: SCRIPT-H-SCREENS.md, 168 items
...
stats: {'sentence_mean': 10.7, 'sentence_count': 209, 'word_count': 2229, 'rehook_positions_pct': []}
RESULT: clean
```
  ...
  short_figure_share: 14.8%
   ...
   hook_properties: present-tense=y, viewer-facing=n
       ...
       first_you_s: 16.6
         cta_count: 1
           rehooks: ['2.0m', '6.7m']
         phase_map: {'P1 OPEN': '0.0-1.5m', 'P2 ENGINE': '1.5-2.9m', 'P3 GAP': '2.2-5.9m', 'P4 PIVOT': '5.9-7.2m', 'P5 REFLECTION': '7.2-11.3m', 'P6 CLOSE': '11.5-13.0m'}
  p3_units_expected: 2
         a3_anchor: 1:18
         pivot_pct: None
     timing_source: estimated (a take exists but is of DIFFERENT text — not used)

  [INFO] doc 37 sec 8: 12,705 chars exceeds the mv2 10,000 cap — chained take required, split at a phase boundary
...
=== OPENING STRUCTURE GATE: SCRIPT-H-VO.txt ===
     ...
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:44
             cycle: checked 0:00-7:26; longest gap 49s from 3:54
    ...
    beats_declared: {'ring': ['0:00', '6:37', '7:24'], 'tricolon': ['0:03'], 'stakes': ['0:09'], 'archetype': ['0:20'], 'payoff': ['0:29'], 'reflect': ['0:36'], 'promise': ['0:38'], 'desire': ['0:45'], 'map': ['0:50'], 'opponent': ['0:52'], 'rehook': ['0:59', '3:37'], 'catalyst': ['1:03'], 'foreshadow': ['1:04', '5:58'], 'new': ['1:14', '1:18', '1:35', '2:32', '3:11', '3:54', '4:42', '5:04', '7:24'], 'head-fake': ['1:21'], 'debate': ['1:31'], 'loop': ['1:48', '1:54'], 'loop-close': ['1:58'], 'dip': ['2:05'], 'signpost': ['2:08', '5:44'], 'anaphora': ['2:16', '5:38', '7:24', '7:24'], 'turn': ['2:53'], 'concede': ['3:26']}
  ...
  [FAIL ] G34 2 sentences, 3:26-3:37 (11s): 'Put my agreement on the record, because the cycle is real an...'
          U6 / E20 concession budget: an agreement run never exceeds 2 sentences or 10s without a claim of ours
  [FAIL ] G44 no rehook in unit 2 4:05-6:28
  ...
  [WARN ] G43 1/6 declared beats open on a gap/consequence connector
  ...
  [PASS ] G19 closed by [loop] at 1:48
  ...
  [PASS ] G36 longest stretch without a cycle beat: 49s from 3:54
  ...
  [JUDGE] J11 read the line at 1:31
...
RESULT: 6 FAIL / 2 WARN / 38 PASS / 12 JUDGE (read these) / 0 INFO
```
...
```
SCRIPT-H-SCREENS.md: X1=75 deixis=30 junctions=18 anchors=45 declared=40
```
