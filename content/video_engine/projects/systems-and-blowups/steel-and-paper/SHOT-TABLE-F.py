...
(166.8, 175.9, "world-sell-ticket-v1"      ,     (.05,  10,   8), [("silicon-reality-gap-s03-teacher-stamped",0,167.2,175.8)]),  # record earnings vs valuation - the profit-taking case
...
(335.9, 342.7, "world-orderbook-stamped-v1",     (.05, -12,  -6), [("silicon-antidote-s04-teacher-stamped",0,336.2,342.6)]),  # the historical blind spot: debt-financed overinvestment
...
(466.0, 476.0, "beat-04-014-evidence-hierarchy-v1",                        (.05, -14,  -6), [("ev-mechanism-ladder",0,466.0,476.0),("ev-test-scorecard-v1",1,466.5,486.5)]),  # steel answers / paper answers - the sort  # POOL: contracts and shipments beat narrative - the test's own logic
(476.0, 486.8, "world-workbench-triad-v1",       (.04,  10,   8), [("ev-mechanism-ladder",0,476.0,486.5)]),                       # "thirty seconds a holding. run your top five tonight"
...
(675.0, 691.2, "world-listing-barge-v1",         (.05, -10,   6), [("silicon-antidote-s14-diagnostic-matrix-v1",0,676.9,691.0)]),  # accidental concentration, sold as safety
