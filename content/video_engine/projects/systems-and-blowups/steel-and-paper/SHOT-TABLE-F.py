...
( 11.9,  20.5, "world-broadcast-set-v2",         (.04, -14,   6), []),                       # "two million people watched" - an empty finance set
( 20.6,  31.0, "world-two-rooms-divergence-v1",  (.05,  16,  -8), [("ev-mega-vs-spy-v3",0,22.0,31.0)]),      # foundry vs empty boardroom = the two lines
( 31.0,  41.4, "world-dawn-factory-v1",          (.04, -12,   8), [("ev-mega-vs-spy-v3",0,31.0,41.0)]),      # builders up 300%, hyperscalers flat
...
( 45.6,  54.0, "world-three-notch-slate-v1",     (.05, -10,   6), []),                       # one test, three questions - the tally
( 54.0,  63.0, "world-signature-nib-v2",         (.04,  12,   8), []),                       # "by the end you'll run it yourself" - the promise, unmade
( 63.1,  71.3, "world-hype-machine-v2",          (.05, -16,  -6), []),                       # THE OPPONENT AS A MECHANISM: paper in by the ton, one made thing out
( 71.3,  78.3, "world-assay-sort-v1",            (.04,  10,   6), []),                       # "a machine you can test" - the sorter, first sight
# ── P2 ENGINE — the steelman ───────────────────────────────────────────
( 78.5,  90.0, "world-steelman-build-v1",        (.05, -12,   8), []),                       # their case built at full strength by someone who doesn't own it
( 90.0, 102.8, "world-navvy-cutting-v1",         (.05,  14,  -8), [("ev-railway-index-v1",0,85.4,96.0),("ev-railway-gdp-tile-v1",1,96.5,102.5)]),
...
(147.7, 166.8, "world-broadcast-set-v2",         (.04, -12,  -8), []),                       # "the most honest sentence a macro channel has said" - their set
(166.8, 175.9, "world-sell-ticket-v1"      ,     (.05,  10,   8), []),                       # HEAD-FAKE: "any adviser would sign it"
(176.2, 180.9, "world-trading-desk-dark",        (.05, -10,  -6), []),                       # "here's where their own chart gets strange"
# ── P3 GAP · unit 1: the evidence walk ─────────────────────────────────
(181.0, 192.0, "world-internal-memo-v1",         (.04,  12,   6), [("ev-doc-karp",0,181.0,192.0)]),          # Karp on CNBC
...
(234.0, 244.5, "world-molten-pour-v2",           (.04, -10,   8), []),                       # "it was the steel" / "the steel kept working"
(244.8, 248.0, "world-workbench-triad-v1",       (.05,  10,   6), []),                       # u5 rehook: "who's paying for the steel this time"
# ── P3 GAP · unit 2: the debt unit ─────────────────────────────────────
(248.1, 255.8, "world-treasury-cash-count",      (.05, -12,  -8), []),                       # the era it was paid for out of pocket
...
(285.7, 303.0, "world-datacenter-aisle-v1",      (.04, -12,   6), [("ev-capex-consensus-v1",1,286.0,297.0)]),
...
(319.0, 328.0, "world-treasury-cash-count",          (.05, -10,   6), [("ev-doc-macdonald",0,319.0,328.0)]),     # the vessel near empty, still tipping = 94% of OCF
(328.0, 335.9, "world-ledger-page-v1",           (.04,  10,   8), [("ev-doc-macdonald",0,328.0,335.5)]),
(335.9, 342.7, "world-orderbook-stamped-v1",     (.05, -12,  -6), []),                       # "that was true. it stopped being true"
(342.7, 352.6, "world-signature-close",          (.05,  12,   6), []),                       # "they signed a promise, in a year that looked good"
# ── P4 PIVOT ───────────────────────────────────────────────────────────
(352.6, 358.6, "world-two-rooms-divergence-v1",  (.06, -10,  -8), []),                       # "where most people get the whole thing wrong"
...
(432.0, 443.0, "world-gpu-crate-dock-v1",        (.04,  12,  -8), [("silicon-antidote-s11-teacher-stamped",1,434.9,443.0)]),  # orders in, slots gone
...
(504.4, 507.9, "world-seoul-fab-skyline-v1",     (.05, -10,   6), []),                       # "the most extreme number in this whole trade"
...
(562.0, 567.8, "world-steel-mill-night",         (.05, -10,   6), [("silicon-antidote-s02-memory-triopoly-v1",1,562.0,567.5)]),  # the most vertical line is steel
(567.9, 576.7, "world-spike-desk-v1",            (.04,  10,   8), []),                       # "it doesn't care what you were hoping to conclude"
# ── P5 · the tell ──────────────────────────────────────────────────────
(577.1, 588.0, "world-pressure-gauge-v1",        (.05, -14,  -6), []),                       # Bravos' tripwire, then ours
(588.0, 600.0, "world-korea-port-v1",            (.05,  12,   6), []),                       # memory leaving Korea, by the kilo
...
# ── P6 CLOSE ───────────────────────────────────────────────────────────
(628.3, 633.3, "world-modern-certificate-v1",    (.05, -12,   6), []),                       # certificates wear nicer names now
...
(649.0, 656.0, "world-three-notch-slate-v1",     (.04,  10,   6), []),                       # ENUMERATIO: everything we checked holds
(656.0, 663.6, "world-scales-coin-paper-v1",     (.05, -12,   8), []),
(663.8, 675.0, "world-molten-pour-v2",           (.05,  14,  -6), []),                       # more bullish: they're the steel
...
(691.3, 697.2, "world-two-rooms-divergence-v1",  (.06,  10,   8), []),                       # FINAL TRIAD: steel used / paper believed
(697.7, 712.0, "world-workbench-triad-v1",       (.04, -12,   6), []),                       # CTA: you now have the test
(712.0, 721.3, "world-statement-kitchen",        (.05,  12,  -8), []),                       # future pacing: which half of your portfolio is steel
