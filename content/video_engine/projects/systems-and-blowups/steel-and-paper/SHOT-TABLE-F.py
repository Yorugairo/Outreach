...
( 11.9,  20.5, "world-adviser-signature-v1",         (.04, -14,   6), [("ev-mega-vs-spy-v3",0,14.6,20.4)]),  # 'The chart is right' SUMMONS the chart
( 20.6,  31.0, "world-share-office-queue-v1",  (.05,  16,  -8), [("ev-mega-vs-spy-v3",0,22.0,31.0)]),      # foundry vs empty boardroom = the two lines
( 31.0,  41.4, "world-gpu-crate-dock-v1",          (.04, -12,   8), [("ev-mega-vs-spy-v3",0,31.0,41.0)]),      # builders up 300%, hyperscalers flat
...
( 71.3,  78.3, "world-assay-sort-v1",            (.04,  10,   6), [("silicon-antidote-s14-teacher-stamped",0,71.5,78.2)]),  # the diagnostic matrix - the machine you can test
...
(147.7, 166.8, "world-broadcast-set-v2",         (.04, -12,  -8), [("ev-tnx-two-eras-v3",1,148.0,157.0),("silicon-antidote-s13-teacher-stamped",0,157.5,166.7)]),  # their line on the record, then the racetrack
(166.8, 175.9, "world-sell-ticket-v1"      ,     (.05,  10,   8), [("silicon-reality-gap-s03-teacher-stamped",1,167.2,175.8)]),  # record earnings vs valuation - the profit-taking case
...
(335.9, 342.7, "world-orderbook-stamped-v1",     (.05, -12,  -6), [("silicon-antidote-s04-teacher-stamped",1,336.2,342.6)]),  # the historical blind spot: debt-financed overinvestment
...
# ── P5 · the tell ──────────────────────────────────────────────────────
(577.1, 588.0, "world-pressure-gauge-v1",        (.05, -14,  -6), [("silicon-reality-gap-s12-teacher-stamped",0,577.5,588.0)]),  # paper-bubble mechanics - their tripwire, then ours
...
# ── P6 CLOSE ───────────────────────────────────────────────────────────
(628.3, 633.3, "world-modern-certificate-v1",    (.05, -12,   6), [("silicon-reality-gap-s13-teacher-stamped",1,628.5,633.2)]),  # advanced memory is no longer swappable
...
(649.0, 656.0, "world-three-notch-slate-v1",     (.04,  10,   6), [("silicon-antidote-s14-teacher-stamped",0,649.2,656.0)]),  # ENUMERATIO: the diagnostic matrix recaps
...
(663.8, 675.0, "world-steel-mill-night" ,           (.05,  14,  -6), [("silicon-antidote-s15-teacher-stamped",0,664.2,675.0)]),  # the physical antidote to a paper bubble
...
(691.3, 697.2, "world-molten-pour-v2",  (.06,  10,   8), []),                       # FINAL TRIAD: steel used / paper believed
