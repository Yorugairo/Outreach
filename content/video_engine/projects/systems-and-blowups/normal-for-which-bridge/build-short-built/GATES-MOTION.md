...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\normal-for-which-bridge\build-short-built ===
  ...
  [FAIL ] M11 first chart enters full and unannotated - declare a spotlight/callout/punch on its divergence within 1.5s AFTER the page's build lands at 0.0s (never over the build); WARN no sound cue within 1.5s of the enter at 0.0s (no evidence species in the timeline - every dock treated as a chart candidate); window 0-10s (E44 short: the page rolls out on the hook - the chart is the mechanism by 0:10)
  ...
  [WARN ] M21 1 page(s) deployed past 12s after the last data mark: s01 13.8s (0:00 -> 0:13) - un-draw it (undraw) or let it become the next thing (figure, another display, the morph)
...
RESULT: 1 FAIL / 2 WARN / 12 PASS / 1 JUDGE / 7 INFO
```

TIMELINE: bridge-short.timeline.json sha256:74783bd3b84631b4e8c880fc15052a69dc0f28e6c0e20d631c046771af44907c
VERDICT: FAIL (1 FAIL)
