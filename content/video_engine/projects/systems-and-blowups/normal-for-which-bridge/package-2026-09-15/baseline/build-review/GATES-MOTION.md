...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\normal-for-which-bridge\build-review ===
  ...
  [PASS ] M25 no settled card on the chart's data, on a line of the page's ink or in the caption strip over 23 instants probed; smallest type read 14.4 CSS px on a phone (floor 11) | INFO, listed not scored (CSS px on a phone): source (the citation) 9.4
  ...
  [PASS ] M27 no card reads over a ledger page's ink over 23 instants probed (0 not-parked card reading(s) measured)
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 23 instants probed (1,227 label pair(s) checked)
  ...
  [INFO ] M07 short: 0 full minute(s) in 57s - opening 185.6 events/min, 5.3 evidence entries/min; whole runtime 184.5/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M21 1 page(s) deployed 8-12s after the last data mark (a dock's clip may hold it): s05 10.0s (0:37 -> 0:47)
  ...
  [INFO ] M26 no bars page printed a value at any of the 23 instants probed - nothing to check (a line page's numbers are its tags, not a height)
  ...
  [INFO ] M31 1 transition(s) leave the stage empty UNDER A LIVE SENTENCE (6.5% of the runtime empty); worst s02 exit=cut 3.1s at 0:21 over "Now put that number on the..." - the page that follows takes an inked arrival (enter=axes or built) or the cut lands later
...
RESULT: 0 FAIL / 1 WARN / 17 PASS / 1 JUDGE / 6 INFO
```

TIMELINE: bridge-short.timeline.json sha256:19a9ec48ba13e862a0aaf3781ec7a6e9024abc4cf34aa3c10ed8e45073d8db99
VERDICT: PASS (0 FAIL)
