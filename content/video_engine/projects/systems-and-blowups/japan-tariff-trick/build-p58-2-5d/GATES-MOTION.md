...
```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\japan-tariff-trick\build-p58-2-5d ===
               runtime: 1:25
         visual_events: 287 (201.9/min)
                 docks: 6
           dock_source: timeline
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:209/8 1:00:183/7
  ...
  [INFO ] M07 short: 1 full minute(s) in 85s - opening 209.0 events/min, 8.0 evidence entries/min; tail from 1:00 182.8/min; whole runtime 200.5/min - no minute distribution to rank in (E21 is judged on the whole)
...
TIMELINE: japan-short.timeline.json sha256:161acba02d3ef7b59fa190202f0b820e2c278927190affca4e28d699ca5f24db
VERDICT: PASS (0 FAIL)
