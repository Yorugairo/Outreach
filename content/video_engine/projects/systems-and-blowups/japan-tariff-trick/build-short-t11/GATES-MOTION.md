# MOTION GATE — build-short-t11

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\japan-tariff-trick\build-short-t11 ===
               runtime: 1:25
         visual_events: 294 (206.9/min)
                 docks: 6
           dock_source: timeline
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:216/8 1:00:183/7

  [PASS ] M01 longest still stretch 2.1s at 0:27
  ...
  [PASS ] M06 60 caption pages = 42/min, 4.1 words/page
  ...
  [PASS ] M16 longest gap between visual events 2.1s at 0:27; 0 gap(s) over 2.5s
          doc 49 s49.6 / operator 2026-09-05: the short-form gate is the pulse - no gap between visual events over 2.5 s; no ceiling
  [INFO ] M07 short: 1 full minute(s) in 85s - opening 216.0 events/min, 8.0 evidence entries/min; tail from 1:00 182.8/min; whole runtime 205.5/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M21 3 page(s) deployed 8-12s after the last data mark (a dock's clip may hold it): s04 8.4s (0:21 -> 0:30); s06 10.2s (0:35 -> 0:45); s08 8.2s (0:51 -> 1:00)
...
RESULT: 0 FAIL / 0 WARN / 14 PASS / 1 JUDGE / 9 INFO
```

TIMELINE: japan-short.timeline.json sha256:70fed2e3cb82719fa9cf0a767ae19a0dc7ce3236feb2233e6d9dd54c9f98c595
VERDICT: PASS (0 FAIL)
