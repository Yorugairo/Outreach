# MOTION GATE — build-short-p49

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\japan-tariff-trick\build-short-p49 ===
               runtime: 1:25
         visual_events: 296 (208.3/min)
                 docks: 6
           dock_source: timeline
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:218/8 1:00:183/7
  ...
  [INFO ] M07 short: 1 full minute(s) in 85s - opening 218.0 events/min, 8.0 evidence entries/min; tail from 1:00 182.8/min; whole runtime 206.9/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M21 1 page(s) deployed 8-12s after the last data mark (a dock's clip may hold it): s06 10.2s (0:35 -> 0:45)
...
TIMELINE: japan-short.timeline.json sha256:0ab730129b1d7afdbd5593b84cef25301d3a6e20f7b7a392d6020c2450d73a7b
VERDICT: PASS (0 FAIL)
