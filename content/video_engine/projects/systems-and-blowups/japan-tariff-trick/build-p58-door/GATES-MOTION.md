# MOTION GATE — build-p58-door

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\japan-tariff-trick\build-p58-door ===
               runtime: 1:25
         visual_events: 283 (199.1/min)
                 docks: 6
           dock_source: timeline
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:205/8 1:00:183/7
  ...
  [INFO ] M07 short: 1 full minute(s) in 85s - opening 205.0 events/min, 8.0 evidence entries/min; tail from 1:00 182.8/min; whole runtime 197.7/min - no minute distribution to rank in (E21 is judged on the whole)
...
RESULT: 0 FAIL / 0 WARN / 14 PASS / 1 JUDGE / 12 INFO
```

TIMELINE: japan-short.timeline.json sha256:9f298f2c6a2758e300a1063ad1ece42efe46bc6c41bd91c8e529564aaf66e382
VERDICT: PASS (0 FAIL)
