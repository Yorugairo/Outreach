...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\japan-tariff-trick\build-short ===
  ...
  [PASS ] M11 first chart ledger:s02 enters at 1.7s, its build lands at 1.7s, with spotlight at 2.6s; window 0-10s (E44 short: the page rolls out on the hook - the chart is the mechanism by 0:10)
  ...
  [PASS ] M16 longest gap between visual events 2.0s at 0:26; 0 gap(s) over 2.5s
          doc 49 s49.6 / operator 2026-09-05: the short-form gate is the pulse - no gap between visual events over 2.5 s; no ceiling
  [INFO ] M07 short: 1 full minute(s) in 81s - opening 228.0 events/min, 8.0 evidence entries/min; tail from 1:00 184.6/min; whole runtime 216.1/min - no minute distribution to rank in (E21 is judged on the whole)
  ...
  [INFO ] M21 1 page(s) deployed 8-12s after the last data mark (a dock's clip may hold it): s06 9.6s (0:33 -> 0:42)
...
RESULT: 0 FAIL / 0 WARN / 14 PASS / 1 JUDGE / 5 INFO
```

TIMELINE: japan-short.timeline.json sha256:d7cb4c7c08510ebd361a54c3f09ebb90b6c10740ef56546eafcab852327398e5
VERDICT: PASS (0 FAIL)
