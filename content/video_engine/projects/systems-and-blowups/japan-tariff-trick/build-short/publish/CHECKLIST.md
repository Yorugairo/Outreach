# Publish checklist - How Japan Tricked Trump (Money Physics - short) - `build-short`

9:16 - 1:25 - every step below is a HUMAN's. The package is written from the build's own artifacts; scheduling and API posting are out of scope (R26-8).

**The master:** `render/japan-short-full-1440p-2026-09-08-superseded.mp4` (49.9 MB) - ONE file serves YouTube, Facebook and Instagram (R26-8: the platform assigns the better codec at 1440p+ and the same upload travels). Never render a per-platform size.
