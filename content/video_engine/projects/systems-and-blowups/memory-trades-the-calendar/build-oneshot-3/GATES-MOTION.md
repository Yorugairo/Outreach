...
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\memory-trades-the-calendar\build-oneshot-3 ===
               runtime: 1:17
         visual_events: 235 (181.6/min)
                 docks: 5
           dock_source: timeline
          ledger_pages: 6
  still_over_12s_share: 0%
            per_minute: 0:00:189/9

  [FAIL ] M16 longest gap between visual events 3.5s at 0:58; 1 gap(s) over 2.5s: 0:58+3.5s - add motion there (a species, a caption pop, plate life); never cut motion to pass
  ...
  [FAIL ] M28 16 pair(s) of a page's own labels sitting on each other over 46 instants probed: tick:Dec on val:-12.4% at 0:44 (s06), 1,152 px, 36 % of the smaller label; tick:Oct '24 on tick:Dec at 0:44 (s06), 880 px, 28 % of the smaller label; tick:Oct '24 on val:-12.4% at 0:44 (s06), 768 px, 14 % of the smaller label; val:-12.4% on tick:Jan at 0:44 (s06), 304 px, 11 % of the smaller label; val:10.9% on pill:-13.8% at 0:44 (s06), 300 px, 6 % of the smaller label; val:-10.5% and val:-11.3% at 0:44 (s06), 0 px of air - under a quarter of a figure (6 at 40 px): the eye reads one string (R26-53) ... - fit the row (lpFitValues), raise the pill to its band (lpPillBand) or move the label; a number on a number is not a number
  ...
  [WARN ] M06 62 caption pages = 48/min, 3.6 words/page
  ...
  [PASS ] M01 longest still stretch 3.5s at 0:58
  ...
  [INFO ] M07 short: 1 full minute(s) in 78s - opening 189.0 events/min, 9.0 evidence entries/min; whole runtime 180.1/min - no minute distribution to rank in (E21 is judged on the whole)
...
RESULT: 4 FAIL / 2 WARN / 15 PASS / 1 JUDGE / 7 INFO
```

TIMELINE: calendar-short.timeline.json sha256:eb33e7df6f3e5d4253daf630f23b8fd1ab2741b776a3cc22fd88dc51f7f62299
VERDICT: FAIL (4 FAIL)
