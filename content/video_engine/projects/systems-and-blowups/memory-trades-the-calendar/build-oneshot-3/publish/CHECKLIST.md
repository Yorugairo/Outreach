# Publish checklist - Memory stocks trade the calendar, not the news (Money Physics - short) - `build-oneshot-3`

9:16 - 1:18 - every step below is a HUMAN's. The package is written from the build's own artifacts; scheduling and API posting are out of scope (R26-8).
