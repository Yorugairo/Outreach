...
generated: 2026-09-05T13:09:07+00:00
script_hash: db8cae1b4e729596c58ff09d439fe2eb91d0b750930734f5835e0a5257887221
timing_source: estimated

TOOLS      lint: exit 0, 0 fails | audit: exit 0, 0/1, timing=estimated |
           opening gate: exit 0, 0/0/45/12 | screens: SCRIPT-90S-SCREENS.md, 11 items
...
```
stats: {'sentence_mean': 11.9, 'sentence_count': 34, 'word_count': 406, 'rehook_positions_pct': [12, 48]}
RESULT: clean
```
...
=== SCRIPT-90S-VO.txt ===
     ...
     sentence_mean: 11.9
      break_ration: 0.78
  sentence_mean_carrying: 12.9
  short_figure_share: 8.8%
    sentence_stdev: 4.6
     over_20_share: 0.0%
       hook_spread: 2%
   hook_properties: present-tense=y, viewer-facing=n
       ...
       first_you_s: 6.1
         cta_count: 0
           rehooks: ['0.3m', '1.1m']
         phase_map: {'P1 OPEN': '0.0-0.3m', 'P2 ENGINE': '0.3-1.6m', 'P3 GAP': '0.4-1.1m', 'P4 PIVOT': '1.1-1.4m', 'P5 REFLECTION': '1.4-2.2m', 'P6 CLOSE': '1.0-2.5m'}
  p3_units_expected: 1
         a3_anchor: 0:15
         pivot_pct: None
     timing_source: estimated (no take on disk)

  [WARN] MAP sec 1: P1 computes to 20s; the open is pinned 60-90s at every runtime
  [INFO] doc 38 B1-B4: owned by gate_opening_structure - see content\video_engine\projects\systems-and-blowups\korea-memory-toll\SCRIPT-90S-GATES.md
...
=== OPENING STRUCTURE GATE: SCRIPT-90S-VO.txt ===
     ...
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:14
             cycle: checked 0:00-2:29; longest gap 28s from 1:54
      unit_windows: ['P3 unit 1 0:25-1:07', 'P5 unit 2 1:22-2:09']
      counterparty: Korea
              ring: toll booth
         packaging: title='The Silicon Toll Booth' thumb=None thumb_file=None
    not_gated_here: Truby Battle / Self-Revelation / New Equilibrium, Snyder midpoint, chiastic center, ring CLOSE (P4-P6)
    beats_declared: {'ring': ['0:02', '2:22'], 'archetype': ['0:07'], 'stakes': ['0:13'], 'rehook': ['0:17', '1:07', '1:54'], 'opponent': ['0:21'], 'reflect': ['0:25', '1:07'], 'tricolon': ['0:30'], 'desire': ['0:33'], 'map': ['0:37'], 'payoff': ['0:40'], 'new': ['0:40', '0:51', '0:56', '1:00', '1:17'], 'promise': ['0:45'], 'foreshadow': ['0:45'], 'catalyst': ['0:51'], 'head-fake': ['0:56'], 'debate': ['1:00'], 'loop': ['1:00', '1:07', '1:17'], 'signpost': ['1:28'], 'loop-close': ['1:47'], 'dip': ['1:54']}

  [PASS ] G01 first sentence 2.79s
          PLATFORM 3s microhook (38 B1 / P1 QC)
  [PASS ] G03 paid at 7.86s, settle at 7.86s
  ...
  [PASS ] G11 'In sixty seconds, you'll calculate the wafer penalty driving this surg'
  ...
  [PASS ] G14 [opponent] at 0:21
          Truby Opponent / McKee antagonism: the opponent named, a MECHANISM never a villain (38 B5)
  [PASS ] G15 'toll booth' planted at 0:00
          Ring composition: the ring token PLANTED in P1 (38 B5 / doc 32 s5)
  [PASS ] G15b close shares 3 content stem(s) with the P1 claim (need 2); claim stems: ['korea', 'open', 'silicon', 'south']
  ...
  [PASS ] G45 title-word proxy: ['silicon', 'toll', 'booth'] echoed in sentence 1
  ...
  [JUDGE] J05 'South Korea just opened a silicon toll booth.' -> 'And shattered its all-time annual export record ta'
...
```
SCRIPT-90S-SCREENS.md: X1=2 deixis=0 junctions=1 anchors=8 declared=30
```
