# V14 measured opening gate

Fresh 596.65-second Kokoro take; hyphen-token timing correction applied.
Raw failures retained. Operator accepted G01's 3.06-second hook editorially;
the global threshold remains unchanged.

```text
=== OPENING STRUCTURE GATE: REVISED-V14-VO.txt ===
           runtime: 9:56
            timing: measured (take)
          geometry: P1 0:00-1:03 (beat 5 from 0:42), P2 -2:25 (phase guides)
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:59
             cycle: checked 0:00-9:56; longest gap 52s from 2:57
      unit_windows: ['P3 unit 1 1:41-4:28', 'P5 unit 2 5:27-8:38']
    ...
    beats_declared: {'archetype': ['0:12'], 'stakes': ['0:20'], 'payoff': ['0:28', '3:49', '4:50', '5:55', '6:33', '8:17', '8:21'], 'reflect': ['0:28', '2:05'], 'promise': ['0:32'], 'desire': ['0:47'], 'opponent': ['0:49'], 'ring': ['0:53', '9:27'], 'map': ['0:57'], 'rehook': ['0:57', '2:57', '4:23', '5:31', '6:53', '7:39'], 'foreshadow': ['0:57', '4:03'], 'tricolon': ['1:03'], 'head-fake': ['1:21'], 'catalyst': ['1:36'], 'new': ['1:43', '1:49', '2:10', '2:30'], 'loop': ['1:53', '2:24'], 'debate': ['2:40'], 'loop-close': ['2:44', '9:00'], 'dip': ['2:48'], 'signpost': ['2:51']}
  ...
  [PASS ] G19 closed by [loop] at 1:53
  ...
  [PASS ] G36 longest stretch without a cycle beat: 52s from 2:57
          CLK the cycle repeats per beat - hook / show it's worth it / promise more / deliver; no >60s without a cycle beat, 0:00-9:56 (E23: whole runtime)
  ...
  [PASS ] G46 runtime 9:56 (measured) clears the 8:00 floor
...
RESULT: 4 FAIL / 2 WARN / 44 PASS / 13 JUDGE (read these) / 0 INFO
