...
=== OPENING STRUCTURE GATE: REVISED-V15-VO.txt ===
     ...
     density_bands: loops (2, 3), new-info (4, 6)
         a3_anchor: 0:53
             cycle: checked 0:00-8:53; longest gap 46s from 2:39
      unit_windows: ['P3 unit 1 1:30-4:00', 'P5 unit 2 4:53-7:44']
    ...
    beats_declared: {'archetype': ['0:10'], 'stakes': ['0:18'], 'payoff': ['0:26', '3:25', '4:19', '5:18', '5:51', '7:25', '7:28'], 'reflect': ['0:26', '1:53'], 'promise': ['0:29'], 'desire': ['0:41'], 'opponent': ['0:47'], 'ring': ['0:51', '8:27'], 'map': ['0:55'], 'rehook': ['0:55', '1:03', '2:39', '3:55', '4:56', '6:51'], 'foreshadow': ['0:55', '3:38'], 'tricolon': ['0:55'], 'head-fake': ['1:14'], 'new': ['1:26', '1:33', '1:38', '1:57', '2:14', '6:10'], 'catalyst': ['1:26'], 'loop': ['1:42', '2:04'], 'debate': ['2:04'], 'loop-close': ['2:33', '8:03'], 'signpost': ['2:33'], 'dip': ['2:39']}

  [WARN ] G09 promise at 0:29 - before the mini-payoff window opens
  ...
  [PASS ] G19 closed by [loop] at 1:42
          The catalyst is a micro loop CLOSED inside 30-60s, not exposition (P2)
  [PASS ] G20 longest gap 25s; review information gain against narration
  ...
  [PASS ] G24 [head-fake] at 1:14
          Truby Plan v1 / head-fake #1 planted STRAIGHT, early-mid P2 (P2 MANDATORY / MAP s4)
  [PASS ] G25 A3 at 0:55
          PLATFORM rehook A3 at ~10% of runtime = 0:53 (P2 / MAP s4 QC; audit and gate share kit_spec.a3_anchor_s, E23)
  ...
  [PASS ] G36 longest stretch without a cycle beat: 46s from 2:39
          CLK broad beat-activity spacing - declared beats keep the argument active but do not certify an intentional hook or STR loop; no >60s without a cycle beat, 0:00-8:53 (E23: whole runtime)
  [PASS ] G37 [archetype] at 0:10
          Truby Weakness/Need planted AS PEOPLE: an archetype-in-a-setting enters 0:08-0:30 (38 B3 / MAP s3)
  [PASS ] G38 [desire] at 0:41
  ...
  [PASS ] G46 runtime 8:53 (measured) clears the 8:00 floor
  ...
  [JUDGE] J02 read the line at 1:14
  ...
  [JUDGE] J09 read the line at 0:10
  ...
  [JUDGE] J11 read the line at 2:04
