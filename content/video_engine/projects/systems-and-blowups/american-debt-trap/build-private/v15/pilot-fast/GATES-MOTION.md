# MOTION GATE — pilot-fast

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\american-debt-trap\build-private\v15\pilot-fast ===
               runtime: 2:57
         visual_events: 533 (179.7/min)
   caption_page_events: 615 from 109 page(s) (24 anchor, 85 stage) + 506 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor (R26-232)
        live_page_life: 25 event(s) every 1.613s inside s01 0:00-0:10, s09 1:21-1:26, s10 1:26-1:33, s11 1:33-1:42 - the PULSE rows M05/M10/M16 only (R26-232)
                 docks: 0
           dock_source: evidence-dock.json
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:185/1 1:00:168/4 2:00:185/0
  ...
  [WARN ] M23 1 transition(s): s11 compare 1:40+2.4s - s11 compare at 1:40 ends inside the last 0.5 s of its page (E45: never over a build; E50: a transition is how a chart leaves, not a cut wearing a verb)
  ...
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M04 15 distinct plates; target runtime/12s = 14
  ...
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 24 anchor, 85 stage page(s), 506 word arrival(s)
  ...
  [PASS ] M21 every ledger page leaves or un-draws within 8s of its last data mark: s01 7.9s (0:03 -> 0:10); s09 2.1s (1:24 -> 1:26); s10 4.2s (1:29 -> 1:33); s11 5.9s (1:36 -> 1:42); s14 1.8s (2:00 -> 2:02)
  ...
  [INFO ] M07 short: 2 full minute(s) in 178s - opening 185.0 events/min, 1.0 evidence entries/min; tail from 1:00 168.0/min; whole runtime 179.0/min - no minute distribution to rank in (E21 is judged on the whole)
...
TIMELINE: american-debt-trap-v15-pilot.timeline.json sha256:cefb94d0fa3b79b217c9ca7183a63cf9933ff9d37c11f8fe281383b2de00d15b
VERDICT: FAIL (1 FAIL)
