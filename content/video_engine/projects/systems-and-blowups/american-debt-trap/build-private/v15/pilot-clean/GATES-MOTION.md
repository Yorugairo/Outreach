# MOTION GATE — pilot-clean

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\american-debt-trap\build-private\v15\pilot-clean ===
               runtime: 3:00
         visual_events: 481 (160.1/min)
   caption_page_events: 549 from 98 page(s) (24 anchor, 74 stage) + 451 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor (R26-232)
        live_page_life: 29 event(s) every 1.613s inside s01 0:00-0:13, s09 1:32-1:38, s10 1:38-1:46, s11 1:46-1:56 - the PULSE rows M05/M10/M16 only (R26-232)
                 docks: 0
           dock_source: evidence-dock.json
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:163/1 1:00:160/3 2:00:156/1

  [FAIL ] M03 longest wait for evidence to enter: 93s from 0:00 (no docks at all)
          doc 29: evidence every 15-45s, every phase incl. P1 and P6 (E21)
  [WARN ] M11 first chart ledger:s01 enters at 0.0s, its build lands at 3.0s, with spotlight at 3.2s; WARN no sound cue within 1.5s of the enter at 0.0s (no evidence species in the timeline - every dock treated as a chart candidate); window 0-3s (operator-directed long-form cold open: the ledger is the opening action by 0:03)
  ...
  [PASS ] M01 longest still stretch 3.0s at 0:06
  ...
  [PASS ] M07 opening minute: 163.0 events/min, 1.0 docks/min - rank 3/3 from the bottom; episode median 160.0/min
          E21: the opening is the densest minute, never the thinnest
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 24 anchor, 74 stage page(s), 451 word arrival(s)
  ...
  [INFO ] M16 longest gap between visual events 2.9s at 2:49; 1 gap(s) over 2.5s - a long-form build; the pulse law binds shorts; TERM page_life (R26-232 (2)): the live page's own life covers 0:06+3.0s in s01 - one event every 1.613s inside a page whose idle resolves to `live` (R26-228 / E99 s83: the lead point's 0.62 Hz spark and halo, the stroke's bloom pulse)
  ...
  [INFO ] M21 1 page(s) deployed 8-12s after the last data mark (a dock's clip may hold it): s01 10.4s (0:03 -> 0:13)
...
RESULT: 1 FAIL / 1 WARN / 15 PASS / 1 JUDGE / 11 INFO
```

TIMELINE: american-debt-trap-v15-pilot.timeline.json sha256:f9ea3b48d072f266a22fb5d4fdcd86eb8a3c460cfdd9e9b3f1184760a02dfeb3
VERDICT: FAIL (1 FAIL)
