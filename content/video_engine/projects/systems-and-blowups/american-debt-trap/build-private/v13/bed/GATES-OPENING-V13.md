...
=== OPENING STRUCTURE GATE: REVISED-V13-VO.txt ===
    ...
    beats_declared: {'archetype': ['0:12'], 'stakes': ['0:20'], 'payoff': ['0:28', '3:50', '4:51', '5:56', '6:34', '8:30'], 'reflect': ['0:28', '2:05'], 'promise': ['0:32'], 'desire': ['0:47'], 'opponent': ['0:49'], 'ring': ['0:53', '9:37'], 'map': ['0:57'], 'rehook': ['0:57', '2:57', '4:24', '5:32', '6:55', '8:02'], 'foreshadow': ['0:57', '4:04'], 'tricolon': ['1:03'], 'head-fake': ['1:21'], 'catalyst': ['1:36'], 'new': ['1:43', '1:49', '2:10', '2:30'], 'loop': ['1:54', '2:25'], 'debate': ['2:41'], 'loop-close': ['2:45', '9:10'], 'dip': ['2:48'], 'signpost': ['2:51']}

  [FAIL ] G01 first sentence 3.06s
          PLATFORM 3s microhook (38 B1 / P1 QC)
  [FAIL ] G22 3 [new] in P2
          PLATFORM density: 4-7 new-info beats at this runtime (P2 geometry)
  [FAIL ] G27 'renewal letter' 0x in P2
          Ring composition: token TOUCHED exactly once in P2, unresolved (P2 / doc 32 s5)
  [FAIL ] G36 longest stretch without a cycle beat: 67s from 6:55
          CLK the cycle repeats per beat - hook / show it's worth it / promise more / deliver; no >60s without a cycle beat, 0:00-10:01 (E23: whole runtime)
  ...
  [WARN ] G20 longest gap 40s; review information gain against narration
  ...
  [PASS ] G13 A1 at 0:32 ([promise]); A2 at 0:57 ([rehook])
  ...
  [PASS ] G46 runtime 10:01 (measured) clears the 8:00 floor
  ...
  [JUDGE] J01 read the [opponent] line at 0:49
...
RESULT: 5 FAIL / 2 WARN / 43 PASS / 13 JUDGE (read these) / 0 INFO
