# Publish checklist - THE HIDDEN FED METRIC BREAKING THE ECONOMY (Fed liquidity pressure) - `build-minute`

16:9 - 1:05 - every step below is a HUMAN's. The package is written from the build's own artifacts; scheduling and API posting are out of scope (R26-8).
