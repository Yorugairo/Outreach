# MOTION GATE — build-pilot

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\fed-liquidity-pressure\build-pilot ===
               runtime: 2:57
         visual_events: 555 (187.1/min)
   caption_page_events: 633 from 122 page(s) (94 anchor, 28 stage) + 511 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor (R26-232)
        live_page_life: no page with idle=live - the pulse rows read the frame's own events alone
                 docks: 1
           dock_source: timeline
          ledger_pages: 5
  still_over_12s_share: 0%
            per_minute: 0:00:195/3 1:00:183/1 2:00:182/2

  [WARN ] M04 7 distinct plates; target runtime/12s = 14
          doc 29 s9.13 plate density
  [WARN ] M11 first chart ledger:s02 enters at 9.2s, its build lands at 9.6s, with spotlight at 9.7s; WARN no sound cue within 1.5s of the enter at 9.2s; window 8-20s (E24 long form: the 8s paradox is paid before the chart enters)
  ...
  [WARN ] M21 4 page(s) deployed past 12s after the last data mark: s06 14.3s (0:55 -> 1:10); s11 19.1s (1:37 -> 1:57); s13 14.1s (2:22 -> 2:36); s14 18.4s (2:39 -> 2:57) - un-draw it (undraw) or let it become the next thing (figure, another display, the morph)
  ...
  [WARN ] M44 1 world plate(s) under 6s (9 world plate(s), floor 6s): s08 3.6s - a plate the eye cannot take in; lengthen it or fold it into its neighbour
  ...
  [PASS ] M01 longest still stretch 1.6s at 1:14
          doc 29 s8.19 / s9.25 stillness ceiling
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M03 longest wait for evidence to enter: 45s from 1:37
          doc 29: evidence every 15-45s, every phase incl. P1 and P6 (E21)
  [PASS ] M05 2 plate(s) over the 20s hold, every one LIVE across it (worst gap 1.5s of 8.0s allowed)
  ...
  [PASS ] M06 122 caption pages = 41/min, 4.2 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 94 anchor, 28 stage page(s), 511 word arrival(s)
  ...
  [PASS ] M23 1 transition(s), each on a built chart and clear of its page's edge: s02 recast 0:11+1.2s
  ...
  [PASS ] M25 no settled card on the chart's data, on a line of the page's ink or in the caption strip over 27 instants probed; smallest type read 9.2 CSS px on a phone (floor 11) | INFO, listed not scored (CSS px on a phone): source (the citation) 8.7
  ...
  [PASS ] M26 17 printed value(s) over 27 instants probed agree with the height drawn on the scale the page prints (band 4% of the top tick + the burst's 5% overshoot); worst 6.4% of the top tick - Fed assets at 2:39
  ...
  [PASS ] M28 no two of a page's own labels touch, and the value row keeps half a figure of air, over 27 instants probed (711 label pair(s) checked)
  ...
  [PASS ] M32 13 boundaries read frame by frame: no flash, no jump, no black outside a dip's core
  ...
  [INFO ] M07 short: 2 full minute(s) in 178s - opening 195.0 events/min, 3.0 evidence entries/min; tail from 1:00 183.0/min; whole runtime 186.4/min - no minute distribution to rank in (E21 is judged on the whole)
          E21: the opening is the densest minute, never the thinnest
  [INFO ] M16 longest gap between visual events 1.6s at 1:14; 0 gap(s) over 2.5s - a long-form build; the pulse law binds shorts
  ...
  [INFO ] M34 no text box met a mark or a series line at any of the 27 instants probed - nothing to check
...
RESULT: 0 FAIL / 4 WARN / 17 PASS / 1 JUDGE / 6 INFO
```

TIMELINE: fed-liquidity-pilot.timeline.json sha256:c77aa1a7563f599d66ea19c32b0e5a89f9785583d567d7796aee45c3457f8f9c
VERDICT: PASS (0 FAIL)
