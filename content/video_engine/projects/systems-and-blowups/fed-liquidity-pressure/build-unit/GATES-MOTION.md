# MOTION GATE — build-unit

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\fed-liquidity-pressure\build-unit ===
               runtime: 1:34
         visual_events: 274 (173.9/min)
   caption_page_events: 318 from 60 page(s) (8 anchor, 52 stage) + 258 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor, 5 unpinned anchored page(s) not counted (R26-232)
  ...
  still_over_12s_share: 0%
            per_minute: 0:00:170/2 1:00:179/0

  [FAIL ] M03 longest wait for evidence to enter: 71s from 0:23
          doc 29: evidence every 15-45s, every phase incl. P1 and P6 (E21)
  [FAIL ] M11 first chart enters full and unannotated - declare a spotlight/callout/punch on its divergence within 1.5s AFTER the page's build lands at 16.6s (never over the build); WARN no sound cue within 1.5s of the enter at 9.2s; window 0-10s (E44 short: the page rolls out on the hook - the chart is the mechanism by 0:10)
  ...
  [FAIL ] M16 longest gap between visual events 4.1s at 0:26; 1 gap(s) over 2.5s: 0:26+4.1s - add motion there (a species, a caption pop, plate life); never cut motion to pass
  ...
  [WARN ] M23 1 transition(s): s02 recast 0:11+1.2s - s02 recast at 0:11 fires inside the page's build beat (E45: never over a build; E50: a transition is how a chart leaves, not a cut wearing a verb)
  ...
  [WARN ] M44 2 world plate(s) under 6s (9 world plate(s), floor 6s): s08 3.6s, s10 4.6s - a plate the eye cannot take in; lengthen it or fold it into its neighbour
  ...
  [PASS ] M01 longest still stretch 4.1s at 0:26
  ...
  [PASS ] M06 65 caption pages = 41/min, 4.3 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 8 anchor, 52 stage page(s), 258 word arrival(s), 5 unpinned anchored page(s) passed over (R26-232)
  ...
  [PASS ] M21 every ledger page leaves or un-draws within 8s of its last data mark: s02 4.8s (0:16 -> 0:21)
  ...
  [INFO ] M07 short: 1 full minute(s) in 95s - opening 170.0 events/min, 2.0 evidence entries/min; tail from 1:00 178.9/min; whole runtime 172.6/min - no minute distribution to rank in (E21 is judged on the whole)
...
RESULT: 3 FAIL / 3 WARN / 11 PASS / 1 JUDGE / 9 INFO
```

TIMELINE: fed-liquidity-unit.timeline.json sha256:8b4a7e50d8149ac4794346e83cfddaa3da9b83146aac4215c997435ca8b6ea3c
VERDICT: FAIL (3 FAIL)
