# MOTION GATE — candidate-a

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\fed-liquidity-pressure\build-opening-chart-proof-v1\candidate-a ===
               runtime: 0:19
         visual_events: 7 (21.6/min)
  ...
  [PASS ] M21 every ledger page leaves or un-draws within 8s of its last data mark: s01 3.4s (0:06 -> 0:09); s02 5.0s (0:14 -> 0:19)
...
RESULT: 0 FAIL / 1 WARN / 12 PASS / 2 JUDGE / 11 INFO
```

TIMELINE: fed-opening-chart-proof.timeline.json sha256:fed9298908a43b8b794ba61c195d18c746a5c1031763d4ca65d36c2f876d1f46
VERDICT: PASS (0 FAIL)
