# MOTION GATE — build-evidence-proof

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\fed-liquidity-pressure\build-evidence-proof ===
               runtime: 0:18
         visual_events: 65 (216.7/min)
   caption_page_events: 72 from 15 page(s) (15 anchor) + 57 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor (R26-232)
        live_page_life: 7 event(s) every 1.613s inside s02 0:08-0:18 - the PULSE rows M05/M10/M16 only (R26-232)
                 docks: 0
  ...
  [FAIL ] M15 s01 callout 4.5-6.5s over the retract from 6.0s - end the species before the retract, or declare exit=cut
          E40 #5 (operator, 2026-09-05): no spotlight on a spiral out - no species window overlaps a page's retract
  [WARN ] M06 15 caption pages = 50/min, 3.8 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [WARN ] M11 first chart ledger:s01 enters at 0.0s, its build lands at 4.0s, with callout at 4.5s; WARN no sound cue within 1.5s of the enter at 0.0s (no evidence species in the timeline - every dock treated as a chart candidate); window 0-10s (E44 short: the page rolls out on the hook - the chart is the mechanism by 0:10)
  ...
  [PASS ] M01 longest still stretch 1.3s at 0:03
          doc 29 s8.19 / s9.25 stillness ceiling
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M03 longest wait for evidence to enter: 10s from 0:08 (no docks at all)
  ...
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 15 anchor page(s), 57 word arrival(s)
  ...
  [PASS ] M16 longest gap between visual events 1.3s at 0:03; 0 gap(s) over 2.5s
  ...
  [PASS ] M21 every ledger page leaves or un-draws within 8s of its last data mark: s01 4.0s (0:04 -> 0:08); s02 4.0s (0:14 -> 0:18)
  ...
  [INFO ] M07 runtime 18s has no full minute to rank - M07 not run (no silent skip)
          E21
...
RESULT: 1 FAIL / 2 WARN / 12 PASS / 1 JUDGE / 9 INFO
```

TIMELINE: fed-evidence-proof.timeline.json sha256:1b8b8e6e75176df4f62d2a64f3519174e957f32cbfa0feffa8e4e14eafe7348e
VERDICT: FAIL (1 FAIL)
