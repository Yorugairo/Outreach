# MOTION GATE — build-bed

```text
=== MOTION DENSITY GATE: C:\Users\Snipe\Downloads\Outreach Program\content\video_engine\projects\systems-and-blowups\fed-liquidity-pressure\build-bed ===
               runtime: 0:30
         visual_events: 75 (148.1/min)
   caption_page_events: 78 from 16 page(s) (8 anchor, 8 stage) + 62 word arrival(s) - the stage register plus the pages a full-stage row PINNED to the anchor, 5 unpinned anchored page(s) not counted (R26-232)
  ...
  [FAIL ] M16 longest gap between visual events 5.4s at 0:24; 1 gap(s) over 2.5s: 0:24+5.4s - add motion there (a species, a caption pop, plate life); never cut motion to pass
  ...
  [PASS ] M01 longest still stretch 5.4s at 0:24
          doc 29 s8.19 / s9.25 stillness ceiling
  [PASS ] M02 0 stretches > 8s (working target)
          doc 29 s9.25
  [PASS ] M03 longest wait for evidence to enter: 14s from 0:09
          doc 29: evidence every 15-45s, every phase incl. P1 and P6 (E21)
  [PASS ] M04 3 distinct plates; target runtime/12s = 2
  ...
  [PASS ] M06 21 caption pages = 41/min, 4.0 words/page
          s9.15 r7 / build_caption_pages 4-6 words
  [PASS ] M08 timeline declares cap_mode; every stretch over the ceiling carries captions (counted as events above); counted: 8 anchor, 8 stage page(s), 62 word arrival(s), 5 unpinned anchored page(s) passed over (R26-232)
  ...
  [INFO ] M07 short: 0 full minute(s) in 30s - opening 146.2 events/min, 4.0 evidence entries/min; whole runtime 144.2/min - no minute distribution to rank in (E21 is judged on the whole)
...
RESULT: 2 FAIL / 1 WARN / 14 PASS / 1 JUDGE / 9 INFO
```

TIMELINE: fed-liquidity-bed.timeline.json sha256:a0c44d979cd6b47b0f203e5e32436b809790c4741f47f99a0df9901bbe0a2fc8
VERDICT: FAIL (2 FAIL)
