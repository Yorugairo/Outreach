"""Isolated contact and full-quote recut using the existing scene engine."""
...
v2.HERE=HERE
v2.EPISODE_ID='knockout-brain-matchcut-001-v6'
v2.TIMELINE_NAME=v2.EPISODE_ID+'.timeline.json'
v2.OUTPUT_NAME=v2.EPISODE_ID+'.mp4'
v2.SHOT_TABLE_RELATIVE='production/assembly-v6/SHOT-TABLE.py'
...
v2.BASE.DEFAULT_EDIT=PROD/'edit-v6.json'
v2.BASE.DEFAULT_AUDIO=PROD/'audio/master-v6.wav'
v2.BASE.DEFAULT_WORD_TIMINGS=PROD/'audio/verdict-v4.words.json'
previous=v2.BASE._write_timeline_inputs
def inputs(*args):
    previous(*args)
    path=v2.BASE.BUILD/'timeline.json'
    payload=json.loads(path.read_text(encoding='utf-8')); payload['script']='production/edit-v6.json'
