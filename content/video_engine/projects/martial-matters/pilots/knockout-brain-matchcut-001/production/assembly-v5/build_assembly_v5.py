"""Isolated verdict-hook and transition revision through scene-evidence."""
...
v2.HERE=HERE
v2.EPISODE_ID='knockout-brain-matchcut-001-v5'
v2.TIMELINE_NAME=v2.EPISODE_ID+'.timeline.json'
v2.OUTPUT_NAME=v2.EPISODE_ID+'.mp4'
v2.SHOT_TABLE_RELATIVE='production/assembly-v5/SHOT-TABLE.py'
...
v2.BASE.DEFAULT_EDIT=PROD/'edit-v5.json'
v2.BASE.DEFAULT_AUDIO=PROD/'audio/master-v5.wav'
...
def inputs(*args):
    ...
    payload=json.loads(path.read_text(encoding='utf-8')); payload['script']='production/edit-v5.json'
